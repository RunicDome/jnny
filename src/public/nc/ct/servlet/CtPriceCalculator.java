...
public class CtPriceCalculator {
	public void relationCalculatePrice(CtPuBVO view) {
	...
	private UFDouble calculateNgtaxprice(CtPuBVO vo) {
	...
	private UFDouble calculateNorigtaxprice(CtPuBVO vo) {
	...
	private UFDouble calculateNoTaxPrice(UFDouble taxPrice, CtPuBVO vo) {

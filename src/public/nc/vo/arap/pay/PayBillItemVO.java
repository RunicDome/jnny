 ...
 * 在此处添加此类的描述信息
 * </p>
 * 创建日期:2009-06-24 12:35:18
 * 
 * @author
 * @version NCPrj ??
 */
public class PayBillItemVO extends BaseItemVO {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8798788816974983824L;
	private static final String DEFAULT_TABLENAME = "ap_payitem";
	private String pk_paybill;
	private String pk_payitem;
	...
	public static final String PK_PAYITEM = "pk_payitem";
	...
	public static final String TOP_TERMCH = "top_termch";
	...
	public static final String FORCEMONEY = "forcemoney";
	public static final String FORCESTATUS = "forcestatus";
	...
	public java.lang.String getPk_paybill() {
		return pk_paybill;
	}

	public void setPk_paybill(java.lang.String newPk_paybill) {
		this.pk_paybill = newPk_paybill;
	}

	public String getPk_payitem() {
		return pk_payitem;
	}

	public void setPk_payitem(String pkPayitem) {
		pk_payitem = pkPayitem;
	}
	...
	public static java.lang.String getDefaultTable() {
		return DEFAULT_TABLENAME;
	}

	public PayBillItemVO() {
		super();
		setBillclass(IBillFieldGet.FK);
	}

	public IVOMeta getMetaData() {
		IVOMeta meta = VOMetaFactory.getInstance().getVOMeta("arap.payitem");
		return meta;
	}
	...
	@Override
	public void setChildrenPK(String pk_payitem) {
		this.pk_payitem = pk_payitem;
	}

	@Override
	public void setParentPK(String pk_paybill) {

...
public class GatheringBillVO extends BaseBillVO {
	private static final long serialVersionUID = -6899445488268175309L;
	private UFDate expectdealdate;
	private String consignagreement;
	private String invoiceno;
	private String creditorreference;
	private UFBoolean sddreversalflag;
	private String reversalreason;
	private String payreason;
	private String failurereason;
	private String sddreversaler;
	private UFDate sddreversaldate;
	...
	public static final String BANKROLLPROJE = "bankrollproje";
	...
	public GatheringBillVO() {
		setBillclass("sk");
	}

	public IVOMeta getMetaData() {
		IVOMeta meta = VOMetaFactory.getInstance().getVOMeta("arap.gatherbill");
		return meta;
	}
	...
	public void setPk_gatherbill(String pkGatherbill) {
		this.pk_gatherbill = pkGatherbill;
	}
	...
	public String getSddreversaler() {
		return this.sddreversaler;
	}

	public void setSddreversaler(String sddreversaler) {

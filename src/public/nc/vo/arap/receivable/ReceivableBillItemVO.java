...
public class ReceivableBillItemVO extends BaseItemVO {
	private static final long serialVersionUID = 4774109736424183723L;
	...
	public String getParentPK() {
		return this.pk_recbill == null ? (String) getAttributeValue("pk_recbill")
				: this.pk_recbill;
	}

 ...
 *     在此处添加此类的描述信息
 * </p>
 * 创建日期:2009-06-24 10:54:26
 * @author 
 * @version NCPrj ??
 */
public class PayableBillVO extends BaseBillVO {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1234071017010199391L;
	...
	public static final String LINKMONEY = "linkmoney";
	public static final String NOINVOICE = "noinvoice";
	public static final String CONTRACTNO = "contractno";

	private UFDouble linkmoney = UFDouble.ZERO_DBL;
	private UFBoolean noinvoice = UFBoolean.TRUE;
	...
	public UFDouble getLinkmoney() {
		return linkmoney;
	}

	public void setLinkmoney(UFDouble linkmoney) {
		this.linkmoney = linkmoney;
	}

	public UFBoolean getNoinvoice() {
		return noinvoice;
	}

	public void setNoinvoice(UFBoolean noinvoice) {

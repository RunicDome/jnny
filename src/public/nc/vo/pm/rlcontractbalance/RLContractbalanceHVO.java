 ...
 * @version NCPrj ??
 */
public class RLContractbalanceHVO extends nc.vo.pub.SuperVO{
    ...
    private nc.vo.pub.lang.UFDouble financialentryadd;
    ...
    private nc.vo.pm.rlcontractbalance.RLContractbalanceBVO[] pk_rl_contr_bal_b;
    ...
    public static final String FINANCIALENTRYADD = "financialentryadd";
    public static final String DBILLDATE = "dbilldate";
    public static final String BILL_NAME = "bill_name";

	/**
	 * 属性 pk_rl_contr_bal的Getter方法.属性名：合同结算单主键
	 *  创建日期:2021-9-22
	...
	/**
	 * 属性pk_rl_contr_bal的Setter方法.属性名：合同结算单主键
	 * 创建日期:2021-9-22
	 ...
	 *  创建日期:2021-9-22
	 * @return nc.vo.pm.rlcontractbalance.RLContractbalanceBVO[]
	 */
	public nc.vo.pm.rlcontractbalance.RLContractbalanceBVO[] getPk_rl_contr_bal_b () {
		return pk_rl_contr_bal_b;
	}   
	/**
	 * 属性pk_rl_contr_bal_b的Setter方法.属性名：结算差异主键
	 * 创建日期:2021-9-22
	 * @param newPk_rl_contr_bal_b nc.vo.pm.rlcontractbalance.RLContractbalanceBVO[]
	 */
	public void setPk_rl_contr_bal_b (nc.vo.pm.rlcontractbalance.RLContractbalanceBVO[] newPk_rl_contr_bal_b ) {
	...
	/**
	 * 属性 bill_code的Getter方法.属性名：单据编码
	 *  创建日期:2021-9-22
	 * @return java.lang.String
	 */
	...
	/**
	 * 属性 transi_type的Getter方法.属性名：交易类型编码
	 *  创建日期:2021-9-22
	 * @return java.lang.String
	 */
	...
	/**
	 * 属性transi_type的Setter方法.属性名：交易类型编码
	 * 创建日期:2021-9-22
	...
	/**
	 * 属性 billmaker 的Getter方法.属性名：制单人
	 *  创建日期:2021-9-22
	 * @return java.lang.String
	 */
	...
	/**
	 * 属性 financialentryadd的Getter方法.属性名：财务入账值（合计金额）
	 *  创建日期:2021-9-22
	 * @return nc.vo.pub.lang.UFDouble
	 */
	public nc.vo.pub.lang.UFDouble getFinancialentryadd () {
		return financialentryadd;
	}   
	/**
	 * 属性financialentryadd的Setter方法.属性名：财务入账值（合计金额）
	 * 创建日期:2021-9-22
	 * @param newFinancialentryadd nc.vo.pub.lang.UFDouble
	 */
	public void setFinancialentryadd (nc.vo.pub.lang.UFDouble newFinancialentryadd ) {
	 	this.financialentryadd = newFinancialentryadd;
	} 	 
	...
	public java.lang.String getTableName() {
		return "pm_rlcontractbalance_ct";
	}    
    ...
    /**
	  ...
	  * 创建日期:2021-9-22
	  */
     public RLContractbalanceHVO() {
		super();	
	}    
	
	
	@nc.vo.annotation.MDEntityInfo(beanFullclassName = "nc.vo.pm.rlcontractbalance.RLContractbalanceHVO" )
	public IVOMeta getMetaData() {
		IVOMeta meta = VOMetaFactory.getInstance().getVOMeta("pm" + "." + "pm_rlcontractbalance_ct");
   		return meta;

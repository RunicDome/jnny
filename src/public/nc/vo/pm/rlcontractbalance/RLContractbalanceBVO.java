 ...
 * @version NCPrj ??
 */
public class RLContractbalanceBVO extends nc.vo.pub.SuperVO{
	
    private java.lang.String pk_rl_contr_bal;
    private java.lang.String pk_rl_contr_bal_b;
    ...
    private nc.vo.pub.lang.UFDouble settlementnum;
    private nc.vo.pub.lang.UFDouble settlementprice;
    private nc.vo.pub.lang.UFDouble financialentrywrit;
    ...
    public static final String PK_RL_CONTR_BAL = "pk_rl_contr_bal";
    public static final String PK_RL_CONTR_BAL_B = "pk_rl_contr_bal_b";
    ...
    public static final String SETTLEMENTNUM = "settlementnum";
    public static final String SETTLEMENTPRICE = "settlementprice";
    public static final String FINANCIALENTRYWRIT = "financialentrywrit";
    public static final String MONEY = "money";
    public static final String UNITMONEY = "unitmoney";
    public static final String NUM = "num";

	/**
	 * 属性 pk_rl_contr_bal的Getter方法.属性名：parentPK
	 *  创建日期:2021-9-22
	 * @return java.lang.String
	 */
	public java.lang.String getPk_rl_contr_bal () {
		return pk_rl_contr_bal;
	}   
	/**
	 * 属性pk_rl_contr_bal的Setter方法.属性名：parentPK
	 * 创建日期:2021-9-22
	 * @param newPk_rl_contr_bal java.lang.String
	 */
	public void setPk_rl_contr_bal (java.lang.String newPk_rl_contr_bal ) {
	 	this.pk_rl_contr_bal = newPk_rl_contr_bal;
	} 	 
	
	/**
	 * 属性 pk_rl_contr_bal_b的Getter方法.属性名：结算差异主键
	 *  创建日期:2021-9-22
	 * @return java.lang.String
	 */
	public java.lang.String getPk_rl_contr_bal_b () {
		return pk_rl_contr_bal_b;
	}   
	/**
	 * 属性pk_rl_contr_bal_b的Setter方法.属性名：结算差异主键
	 * 创建日期:2021-9-22
	 * @param newPk_rl_contr_bal_b java.lang.String
	 */
	public void setPk_rl_contr_bal_b (java.lang.String newPk_rl_contr_bal_b ) {
	 	this.pk_rl_contr_bal_b = newPk_rl_contr_bal_b;
	} 	 
	...
	/**
	 * 属性 settlementnum的Getter方法.属性名：结算数量
	 *  创建日期:2021-9-22
	 * @return nc.vo.pub.lang.UFDouble
	 */
	public nc.vo.pub.lang.UFDouble getSettlementnum () {
		return settlementnum;
	}   
	/**
	 * 属性settlementnum的Setter方法.属性名：结算数量
	 * 创建日期:2021-9-22
	 * @param newSettlementnum nc.vo.pub.lang.UFDouble
	 */
	public void setSettlementnum (nc.vo.pub.lang.UFDouble newSettlementnum ) {
	 	this.settlementnum = newSettlementnum;
	} 	 
	
	/**
	 * 属性 settlementprice的Getter方法.属性名：结算单价
	 *  创建日期:2021-9-22
	 * @return nc.vo.pub.lang.UFDouble
	 */
	public nc.vo.pub.lang.UFDouble getSettlementprice () {
		return settlementprice;
	}   
	/**
	 * 属性settlementprice的Setter方法.属性名：结算单价
	 * 创建日期:2021-9-22
	 * @param newSettlementprice nc.vo.pub.lang.UFDouble
	 */
	public void setSettlementprice (nc.vo.pub.lang.UFDouble newSettlementprice ) {
	 	this.settlementprice = newSettlementprice;
	} 	 
	
	/**
	 * 属性 financialentrywrit的Getter方法.属性名：财务入账值（回写）
	 *  创建日期:2021-9-22
	 * @return nc.vo.pub.lang.UFDouble
	 */
	public nc.vo.pub.lang.UFDouble getFinancialentrywrit () {
		return financialentrywrit;
	}   
	/**
	 * 属性financialentrywrit的Setter方法.属性名：财务入账值（回写）
	 * 创建日期:2021-9-22
	 * @param newFinancialentrywrit nc.vo.pub.lang.UFDouble
	 */
	public void setFinancialentrywrit (nc.vo.pub.lang.UFDouble newFinancialentrywrit ) {
	 	this.financialentrywrit = newFinancialentrywrit;
	} 	 
	...
	public java.lang.String getTableName() {
		return "pm_rlcontractbalance_ct_b";
	}    
    ...
    /**
	  ...
	  * 创建日期:2021-9-22
	  */
     public RLContractbalanceBVO() {
		super();	
	}    
	
	
	@nc.vo.annotation.MDEntityInfo(beanFullclassName = "nc.vo.pm.rlcontractbalance.RLContractbalanceBVO" )
	public IVOMeta getMetaData() {
		IVOMeta meta = VOMetaFactory.getInstance().getVOMeta("pm" + "." + "pm_rlcontractbalance_ct_b");
   		return meta;

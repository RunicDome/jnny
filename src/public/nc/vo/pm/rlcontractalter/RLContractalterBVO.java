...
public class RLContractalterBVO extends nc.vo.pub.SuperVO{
	...
	/**
	 * 属性 pk_contr_alter的Getter方法.属性名：parentPK
	 *  创建日期:2021-9-22
	...
	/**
	 * 属性pk_contr_alter的Setter方法.属性名：parentPK
	 * 创建日期:2021-9-22
	...
	/**
	 * 属性 pk_contr_works的Getter方法.属性名：合同基本主键
	 *  创建日期:2021-9-22
	 * @return java.lang.String
	 */
	...
	/**
	 * 属性pk_contr_works的Setter方法.属性名：合同基本主键
	 * 创建日期:2021-9-22
	...
	/**
	 * 属性 alt_mny的Getter方法.属性名：本次协议金额
	 *  创建日期:2021-9-22
	 * @return nc.vo.pub.lang.UFDouble
	 */
	...
	/**
	 * 属性 alt_mny_num的Getter方法.属性名：本次协议数量
	 *  创建日期:2021-9-22
	 * @return nc.vo.pub.lang.UFDouble
	 */
	...
	/**
	 * 属性alt_mny_num的Setter方法.属性名：本次协议数量
	 * 创建日期:2021-9-22

 ...
 * @version NCPrj ??
 */
public class RLContractschedule extends nc.vo.pub.SuperVO{
    ...
    private nc.vo.pm.rlcontractschedule.RLContractscheduleBVO[] pk_rl_contr_sche_b;
	...
	/**
	 * 属性 pk_rl_contr_sche的Getter方法.属性名：合同进度款主键
	 *  创建日期:2021-9-22
	...
	/**
	 * 属性pk_rl_contr_sche的Setter方法.属性名：合同进度款主键
	 * 创建日期:2021-9-22
	...
	/**
	 * 属性 pk_rl_contr_sche_b的Getter方法.属性名：进度款单明细
	 *  创建日期:2021-9-22
	 * @return nc.vo.pm.rlcontractschedule.RLContractscheduleBVO[]
	 */
	public nc.vo.pm.rlcontractschedule.RLContractscheduleBVO[] getPk_rl_contr_sche_b () {
		return pk_rl_contr_sche_b;
	}   
	/**
	 * 属性pk_rl_contr_sche_b的Setter方法.属性名：进度款单明细
	 * 创建日期:2021-9-22
	 * @param newPk_rl_contr_sche_b nc.vo.pm.rlcontractschedule.RLContractscheduleBVO[]
	 */
	public void setPk_rl_contr_sche_b (nc.vo.pm.rlcontractschedule.RLContractscheduleBVO[] newPk_rl_contr_sche_b ) {
	...
	/**
	 * 属性 bill_code的Getter方法.属性名：进度款单号
	 *  创建日期:2021-9-22
	 * @return java.lang.String
	 */
	...
	/**
	 * 属性bill_code的Setter方法.属性名：进度款单号
	 * 创建日期:2021-9-22
	...
	/**
	 * 属性 billmaketime 的Getter方法.属性名：制单日期
	 *  创建日期:2021-9-22
	...
	/**
	 * 属性billmaketime 的Setter方法.属性名：制单日期
	 * 创建日期:2021-9-22
	...
	/**
	 * 属性 pk_transitype 的Getter方法.属性名：交易类型
	 *  创建日期:2021-9-22
	 * @return java.lang.String
	 */
	...
	/**
	 * 属性pk_transitype 的Setter方法.属性名：交易类型
	 * 创建日期:2021-9-22
	...
	public java.lang.String getTableName() {
		return "pm_rlcontractschedule_ct";
	}    
    ...
    /**
	  ...
	  * 创建日期:2021-9-22
	  */
     public RLContractschedule() {
		super();	
	}    
	
	
	@nc.vo.annotation.MDEntityInfo(beanFullclassName = "nc.vo.pm.rlcontractschedule.RLContractschedule" )
	public IVOMeta getMetaData() {
		
		IVOMeta meta = VOMetaFactory.getInstance().getVOMeta("pm" + "." + "pm_rlcontractschedule_ct");
   		return meta;

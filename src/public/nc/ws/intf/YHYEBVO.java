...
// 银行余额视图VO
public class YHYEBVO extends SuperVO {
	...
	public static final String ZQZZBM = "zqzzbm";
	...
	public String getZqzzbm() {
		return zqzzbm;
	}

	public void setZqzzbm(String zqzzbm) {
		this.zqzzbm = zqzzbm;
	}

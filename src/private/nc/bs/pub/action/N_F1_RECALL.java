...
// 应付单收回
public class N_F1_RECALL extends N_F1_EDIT {
	public N_F1_RECALL() {
	}

	public Object runComClass(PfParameterVO pfparametervo)
			throws BusinessException {
		((BaseAggVO) pfparametervo.m_preValueVos[0]).getHeadVO()
				.setApprovestatus2("RECALL");
		...
		for (AggregatedValueObject temp : pfparametervo.m_preValueVos) {
			...
			PayableBillVO hvo = (PayableBillVO) temp.getParentVO();
			// 单据号，组织主键，事件类型，单据类型

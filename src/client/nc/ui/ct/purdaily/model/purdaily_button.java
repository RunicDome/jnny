...
public class purdaily_button extends AbstractJavaBeanDefinition{
...
public nc.ui.ct.purdaily.action.CGHTPuAddAction getAddAction(){
 ...
 return (nc.ui.ct.purdaily.action.CGHTPuAddAction)context.get("addAction");
  ...
  bean.setInterceptor(getCompositeActionInterceptor_16ed698());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor getCompositeActionInterceptor_16ed698(){
 if(context.get("nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#16ed698")!=null)
 return (nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor)context.get("nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#16ed698");
  ...
  context.put("nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#16ed698",bean);
...
private List getManagedList4(){  List list = new ArrayList();  list.add(getShowUpComponentInterceptor_39e());  return list;}

private nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor getShowUpComponentInterceptor_39e(){
 if(context.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#39e")!=null)
 return (nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor)context.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#39e");
  nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor bean = new nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor();
  context.put("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#39e",bean);
  bean.setShowUpComponent((nc.ui.uif2.components.IAutoShowUpComponent)findBeanInUIF2BeanFactory("billFormEditor"));
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.ct.purdaily.action.PuEditAction getEditAction(){
 ...
 return (nc.ui.ct.purdaily.action.PuEditAction)context.get("editAction");
  ...
  bean.setCardForm((nc.ui.pubapp.uif2app.view.ShowUpableBillForm)findBeanInUIF2BeanFactory("billFormEditor"));
  bean.setModel((nc.ui.uif2.model.AbstractAppModel)findBeanInUIF2BeanFactory("ManageAppModel"));
  bean.setInterceptor(getShowUpComponentInterceptor_1f33649());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor getShowUpComponentInterceptor_1f33649(){
 if(context.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#1f33649")!=null)
 return (nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor)context.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#1f33649");
  nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor bean = new nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor();
  context.put("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#1f33649",bean);
  bean.setShowUpComponent((nc.ui.uif2.components.IAutoShowUpComponent)findBeanInUIF2BeanFactory("billFormEditor"));
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.ct.purdaily.action.PuModiDeleteAction getModiDeleteAction(){
 ...
 return (nc.ui.ct.purdaily.action.PuModiDeleteAction)context.get("modiDeleteAction");
  ...
  bean.setSingleBillService(getPuModiDeleteService_1e006c5());
  bean.setModel((nc.ui.uif2.model.AbstractAppModel)findBeanInUIF2BeanFactory("ManageAppModel"));
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.ct.purdaily.service.PuModiDeleteService getPuModiDeleteService_1e006c5(){
 if(context.get("nc.ui.ct.purdaily.service.PuModiDeleteService#1e006c5")!=null)
 return (nc.ui.ct.purdaily.service.PuModiDeleteService)context.get("nc.ui.ct.purdaily.service.PuModiDeleteService#1e006c5");
  nc.ui.ct.purdaily.service.PuModiDeleteService bean = new nc.ui.ct.purdaily.service.PuModiDeleteService();
  context.put("nc.ui.ct.purdaily.service.PuModiDeleteService#1e006c5",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.ct.purdaily.action.PuAddFromM28Action getPriceDeterAction(){
 ...
 return (nc.ui.ct.purdaily.action.PuAddFromM28Action)context.get("priceDeterAction");
  ...
  bean.setSourceBillName(getI18nFB_1fce714());
...
private java.lang.String getI18nFB_1fce714(){
 if(context.get("nc.ui.uif2.I18nFB#1fce714")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1fce714");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1fce714",bean);  bean.setResDir("4001002_0");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#1fce714",product);
...
public nc.ui.ct.purdaily.action.PuAddFromSourceAction getAddFrom20Action(){
 ...
 return (nc.ui.ct.purdaily.action.PuAddFromSourceAction)context.get("addFrom20Action");
  ...
  bean.setSourceBillName(getI18nFB_6d2525());
  bean.setFlowBillType(false);
  bean.setModel((nc.ui.uif2.model.AbstractAppModel)findBeanInUIF2BeanFactory("ManageAppModel"));
  bean.setEditor((nc.ui.pubapp.uif2app.view.ShowUpableBillForm)findBeanInUIF2BeanFactory("billFormEditor"));
  bean.setTransferViewProcessor((nc.ui.pubapp.billref.dest.TransferViewProcessor)findBeanInUIF2BeanFactory("transferViewProcessor1"));
...
private java.lang.String getI18nFB_6d2525(){
 if(context.get("nc.ui.uif2.I18nFB#6d2525")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#6d2525");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#6d2525",bean);  bean.setResDir("4001002_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#6d2525",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

package nc.ui.aim.worderplan.action;
...
public class CopyActionProcessor implements ICopyActionProcessor<AggWorderplan> {

	@Override
	public void processVOAfterCopy(AggWorderplan paramT,

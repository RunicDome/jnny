...
/*      */ 
/*      */ public class payablebill_record extends nc.ui.uif2.factory.AbstractJavaBeanDefinition
/*      */ {
...
/*      */   }
/*      */   
/*  146 */   private List getManagedList0() { List list = new ArrayList();list.add(getQueryParam_d4d23f());list.add(getQueryParam_372cad());return list;
/*      */   }
/*      */   
/*  149 */   private nc.ui.uif2.userdefitem.QueryParam getQueryParam_d4d23f() { if (context.get("nc.ui.uif2.userdefitem.QueryParam#d4d23f") != null)
/*  150 */       return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#d4d23f");
/*  151 */     nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
/*  152 */     context.put("nc.ui.uif2.userdefitem.QueryParam#d4d23f", bean);
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.userdefitem.QueryParam getQueryParam_372cad() {
/*  160 */     if (context.get("nc.ui.uif2.userdefitem.QueryParam#372cad") != null)
/*  161 */       return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#372cad");
/*  162 */     nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
/*  163 */     context.put("nc.ui.uif2.userdefitem.QueryParam#372cad", bean);
...
/*  323 */     bean.setBlankChildrenFilter(getSingleFieldBlankChildrenFilter_56474e());
/*  324 */     bean.setDefValueItf(getBillDefVauleItf());
/*  325 */     bean.setBodyLineActions(getManagedList2());
/*  326 */     bean.setActions(getManagedList5());
/*  327 */     bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_a68585());
/*  328 */     bean.initRealUI();
...
/*      */   }
/*      */   
/*      */   private nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter getSingleFieldBlankChildrenFilter_56474e() {
/*  335 */     if (context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#56474e") != null)
/*  336 */       return (nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter)context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#56474e");
...
/*  338 */     context.put("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#56474e", bean);
...
/*      */   }
/*      */   
/*  345 */   private List getManagedList2() { List list = new ArrayList();list.add(getAddLineAction());list.add(getInsertLineAction_6392ae());list.add(getBodyDelLineAction_13307c4());list.add(getBodyCopyLineAction_142d88d());list.add(getBodyPasteLineAction_197251e());list.add(getBodyPasteToTailAction_5dfa4());list.add(getActionsBarSeparator());list.add(getBodyLineEditAction_19dc484());list.add(getActionsBarSeparator());list.add(getBillBodyZoomAction_d0f583());return list;
/*      */   }
/*      */   
/*  348 */   private nc.ui.arap.actions.InsertLineAction getInsertLineAction_6392ae() { if (context.get("nc.ui.arap.actions.InsertLineAction#6392ae") != null)
/*  349 */       return (nc.ui.arap.actions.InsertLineAction)context.get("nc.ui.arap.actions.InsertLineAction#6392ae");
/*  350 */     nc.ui.arap.actions.InsertLineAction bean = new nc.ui.arap.actions.InsertLineAction();
/*  351 */     context.put("nc.ui.arap.actions.InsertLineAction#6392ae", bean);
...
/*      */   }
/*      */   
/*      */   private nc.ui.arap.actions.BodyDelLineAction getBodyDelLineAction_13307c4() {
/*  361 */     if (context.get("nc.ui.arap.actions.BodyDelLineAction#13307c4") != null)
/*  362 */       return (nc.ui.arap.actions.BodyDelLineAction)context.get("nc.ui.arap.actions.BodyDelLineAction#13307c4");
/*  363 */     nc.ui.arap.actions.BodyDelLineAction bean = new nc.ui.arap.actions.BodyDelLineAction();
/*  364 */     context.put("nc.ui.arap.actions.BodyDelLineAction#13307c4", bean);
/*  365 */     setBeanFacotryIfBeanFacatoryAware(bean);
/*  366 */     invokeInitializingBean(bean);
/*  367 */     return bean;
/*      */   }
/*      */   
/*      */   private nc.ui.arap.actions.BodyCopyLineAction getBodyCopyLineAction_142d88d() {
/*  371 */     if (context.get("nc.ui.arap.actions.BodyCopyLineAction#142d88d") != null)
/*  372 */       return (nc.ui.arap.actions.BodyCopyLineAction)context.get("nc.ui.arap.actions.BodyCopyLineAction#142d88d");
/*  373 */     nc.ui.arap.actions.BodyCopyLineAction bean = new nc.ui.arap.actions.BodyCopyLineAction();
/*  374 */     context.put("nc.ui.arap.actions.BodyCopyLineAction#142d88d", bean);
/*  375 */     setBeanFacotryIfBeanFacatoryAware(bean);
/*  376 */     invokeInitializingBean(bean);
/*  377 */     return bean;
/*      */   }
/*      */   
/*      */   private nc.ui.arap.actions.BodyPasteLineAction getBodyPasteLineAction_197251e() {
/*  381 */     if (context.get("nc.ui.arap.actions.BodyPasteLineAction#197251e") != null)
/*  382 */       return (nc.ui.arap.actions.BodyPasteLineAction)context.get("nc.ui.arap.actions.BodyPasteLineAction#197251e");
/*  383 */     nc.ui.arap.actions.BodyPasteLineAction bean = new nc.ui.arap.actions.BodyPasteLineAction();
/*  384 */     context.put("nc.ui.arap.actions.BodyPasteLineAction#197251e", bean);
...
/*      */   }
/*      */   
/*  395 */   private nc.ui.arap.actions.BodyPasteToTailAction getBodyPasteToTailAction_5dfa4() { if (context.get("nc.ui.arap.actions.BodyPasteToTailAction#5dfa4") != null)
/*  396 */       return (nc.ui.arap.actions.BodyPasteToTailAction)context.get("nc.ui.arap.actions.BodyPasteToTailAction#5dfa4");
/*  397 */     nc.ui.arap.actions.BodyPasteToTailAction bean = new nc.ui.arap.actions.BodyPasteToTailAction();
/*  398 */     context.put("nc.ui.arap.actions.BodyPasteToTailAction#5dfa4", bean);
...
/*      */   }
/*      */   
/*  409 */   private nc.ui.arap.actions.BodyLineEditAction getBodyLineEditAction_19dc484() { if (context.get("nc.ui.arap.actions.BodyLineEditAction#19dc484") != null)
/*  410 */       return (nc.ui.arap.actions.BodyLineEditAction)context.get("nc.ui.arap.actions.BodyLineEditAction#19dc484");
/*  411 */     nc.ui.arap.actions.BodyLineEditAction bean = new nc.ui.arap.actions.BodyLineEditAction();
/*  412 */     context.put("nc.ui.arap.actions.BodyLineEditAction#19dc484", bean);
/*  413 */     setBeanFacotryIfBeanFacatoryAware(bean);
/*  414 */     invokeInitializingBean(bean);
/*  415 */     return bean;
/*      */   }
/*      */   
/*      */   private nc.ui.arap.actions.BillBodyZoomAction getBillBodyZoomAction_d0f583() {
/*  419 */     if (context.get("nc.ui.arap.actions.BillBodyZoomAction#d0f583") != null)
/*  420 */       return (nc.ui.arap.actions.BillBodyZoomAction)context.get("nc.ui.arap.actions.BillBodyZoomAction#d0f583");
/*  421 */     nc.ui.arap.actions.BillBodyZoomAction bean = new nc.ui.arap.actions.BillBodyZoomAction();
/*  422 */     context.put("nc.ui.arap.actions.BillBodyZoomAction#d0f583", bean);
...
/*      */   }
/*      */   
/*  431 */   private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_a68585() { if (context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#a68585") != null)
/*  432 */       return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#a68585");
/*  433 */     nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
/*  434 */     context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#a68585", bean);
...
/*      */   }
/*      */   
/* 1271 */   private Map getManagedMap0() { Map map = new java.util.HashMap();map.put(getI18nFB_1858dec(), getManagedList8());map.put(getI18nFB_128a188(), getManagedList9());return map;
/*      */   }
/*      */   
/* 1274 */   private String getI18nFB_1858dec() { if (context.get("nc.ui.uif2.I18nFB#1858dec") != null)
/* 1275 */       return (String)context.get("nc.ui.uif2.I18nFB#1858dec");
/* 1276 */     I18nFB bean = new I18nFB();
/* 1277 */     context.put("&nc.ui.uif2.I18nFB#1858dec", bean);bean.setResDir("uif2");
...
/* 1284 */       context.put("nc.ui.uif2.I18nFB#1858dec", product);
...
/*      */   }
/*      */   
/* 1292 */   private String getI18nFB_128a188() { if (context.get("nc.ui.uif2.I18nFB#128a188") != null)
/* 1293 */       return (String)context.get("nc.ui.uif2.I18nFB#128a188");
/* 1294 */     I18nFB bean = new I18nFB();
/* 1295 */     context.put("&nc.ui.uif2.I18nFB#128a188", bean);bean.setResDir("uif2");
...
/* 1302 */       context.put("nc.ui.uif2.I18nFB#128a188", product);
...
/* 1455 */     bean.setName(getI18nFB_851572());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_851572() {
/* 1463 */     if (context.get("nc.ui.uif2.I18nFB#851572") != null)
/* 1464 */       return (String)context.get("nc.ui.uif2.I18nFB#851572");
/* 1465 */     I18nFB bean = new I18nFB();
/* 1466 */     context.put("&nc.ui.uif2.I18nFB#851572", bean);bean.setResDir("pubapp_0");
...
/* 1473 */       context.put("nc.ui.uif2.I18nFB#851572", product);
...
/* 1603 */     bean.setTangramLayoutRoot(getTBNode_bbf2a6());
/* 1604 */     bean.initUI();
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_bbf2a6() {
/* 1611 */     if (context.get("nc.ui.uif2.tangramlayout.node.TBNode#bbf2a6") != null)
/* 1612 */       return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#bbf2a6");
/* 1613 */     nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
/* 1614 */     context.put("nc.ui.uif2.tangramlayout.node.TBNode#bbf2a6", bean);
...
/*      */   }
/*      */   
/* 1622 */   private List getManagedList13() { List list = new ArrayList();list.add(getVSNode_8643bf());list.add(getHSNode_1fa6b0());list.add(getCNode_1c08c2d());list.add(getCNode_6ed28());return list;
/*      */   }
/*      */   
/* 1625 */   private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_8643bf() { if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#8643bf") != null)
/* 1626 */       return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#8643bf");
/* 1627 */     nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
/* 1628 */     context.put("nc.ui.uif2.tangramlayout.node.VSNode#8643bf", bean);
/* 1629 */     bean.setUp(getCNode_187f633());
/* 1630 */     bean.setDown(getCNode_1658710());
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_187f633() {
/* 1639 */     if (context.get("nc.ui.uif2.tangramlayout.node.CNode#187f633") != null)
/* 1640 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#187f633");
/* 1641 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1642 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#187f633", bean);
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_1658710() {
/* 1650 */     if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1658710") != null)
/* 1651 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1658710");
/* 1652 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1653 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#1658710", bean);
/* 1654 */     bean.setName(getI18nFB_134a59f());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_134a59f() {
/* 1662 */     if (context.get("nc.ui.uif2.I18nFB#134a59f") != null)
/* 1663 */       return (String)context.get("nc.ui.uif2.I18nFB#134a59f");
/* 1664 */     I18nFB bean = new I18nFB();
/* 1665 */     context.put("&nc.ui.uif2.I18nFB#134a59f", bean);bean.setResDir("common");
...
/* 1672 */       context.put("nc.ui.uif2.I18nFB#134a59f", product);
/* 1673 */       return (String)product;
/*      */     } catch (Exception e) {
/* 1675 */       throw new RuntimeException(e);
/*      */     } }
/*      */   
/* 1678 */   private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_1fa6b0() { if (context.get("nc.ui.uif2.tangramlayout.node.HSNode#1fa6b0") != null)
/* 1679 */       return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#1fa6b0");
/* 1680 */     nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
/* 1681 */     context.put("nc.ui.uif2.tangramlayout.node.HSNode#1fa6b0", bean);
/* 1682 */     bean.setLeft(getCNode_c9ca83());
/* 1683 */     bean.setRight(getVSNode_115e3d0());
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_c9ca83() {
/* 1691 */     if (context.get("nc.ui.uif2.tangramlayout.node.CNode#c9ca83") != null)
/* 1692 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#c9ca83");
/* 1693 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1694 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#c9ca83", bean);
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_115e3d0() {
/* 1702 */     if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#115e3d0") != null)
/* 1703 */       return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#115e3d0");
/* 1704 */     nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
/* 1705 */     context.put("nc.ui.uif2.tangramlayout.node.VSNode#115e3d0", bean);
/* 1706 */     bean.setUp(getCNode_e6504());
/* 1707 */     bean.setDown(getCNode_6b5eb1());
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_e6504() {
/* 1716 */     if (context.get("nc.ui.uif2.tangramlayout.node.CNode#e6504") != null)
/* 1717 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#e6504");
/* 1718 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1719 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#e6504", bean);
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_6b5eb1() {
/* 1727 */     if (context.get("nc.ui.uif2.tangramlayout.node.CNode#6b5eb1") != null)
/* 1728 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#6b5eb1");
/* 1729 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1730 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#6b5eb1", bean);
/* 1731 */     bean.setName(getI18nFB_109f3e5());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_109f3e5() {
/* 1739 */     if (context.get("nc.ui.uif2.I18nFB#109f3e5") != null)
/* 1740 */       return (String)context.get("nc.ui.uif2.I18nFB#109f3e5");
/* 1741 */     I18nFB bean = new I18nFB();
/* 1742 */     context.put("&nc.ui.uif2.I18nFB#109f3e5", bean);bean.setResDir("common");
...
/* 1749 */       context.put("nc.ui.uif2.I18nFB#109f3e5", product);
/* 1750 */       return (String)product;
/*      */     } catch (Exception e) {
/* 1752 */       throw new RuntimeException(e);
/*      */     } }
/*      */   
/* 1755 */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_1c08c2d() { if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1c08c2d") != null)
/* 1756 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1c08c2d");
/* 1757 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1758 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#1c08c2d", bean);
/* 1759 */     bean.setName(getI18nFB_1f897f5());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_1f897f5() {
/* 1767 */     if (context.get("nc.ui.uif2.I18nFB#1f897f5") != null)
/* 1768 */       return (String)context.get("nc.ui.uif2.I18nFB#1f897f5");
/* 1769 */     I18nFB bean = new I18nFB();
/* 1770 */     context.put("&nc.ui.uif2.I18nFB#1f897f5", bean);bean.setResDir("common");
...
/* 1777 */       context.put("nc.ui.uif2.I18nFB#1f897f5", product);
/* 1778 */       return (String)product;
/*      */     } catch (Exception e) {
/* 1780 */       throw new RuntimeException(e);
/*      */     } }
/*      */   
/* 1783 */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_6ed28() { if (context.get("nc.ui.uif2.tangramlayout.node.CNode#6ed28") != null)
/* 1784 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#6ed28");
/* 1785 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1786 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#6ed28", bean);
/* 1787 */     bean.setName(getI18nFB_32ff0d());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_32ff0d() {
/* 1795 */     if (context.get("nc.ui.uif2.I18nFB#32ff0d") != null)
/* 1796 */       return (String)context.get("nc.ui.uif2.I18nFB#32ff0d");
/* 1797 */     I18nFB bean = new I18nFB();
/* 1798 */     context.put("&nc.ui.uif2.I18nFB#32ff0d", bean);bean.setResDir("common");
...
/* 1805 */       context.put("nc.ui.uif2.I18nFB#32ff0d", product);
...
/*      */   }
/*      */   
/* 1846 */   private List getManagedList14() { List list = new ArrayList();list.add(getDocumentManage());list.add(getActionsBarSeparator());list.add(getFirstLineAction());list.add(getPreLineAction());list.add(getNextLineAction());list.add(getLastLineAction());list.add(getActionsBarSeparator());list.add(getBillHeadZoomAction_1b487e5());return list;
/*      */   }
/*      */   
/* 1849 */   private nc.ui.arap.actions.BillHeadZoomAction getBillHeadZoomAction_1b487e5() { if (context.get("nc.ui.arap.actions.BillHeadZoomAction#1b487e5") != null)
/* 1850 */       return (nc.ui.arap.actions.BillHeadZoomAction)context.get("nc.ui.arap.actions.BillHeadZoomAction#1b487e5");
/* 1851 */     nc.ui.arap.actions.BillHeadZoomAction bean = new nc.ui.arap.actions.BillHeadZoomAction();
/* 1852 */     context.put("nc.ui.arap.actions.BillHeadZoomAction#1b487e5", bean);
...
/* 1931 */     bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_145f758());
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_145f758() {
/* 1939 */     if (context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#145f758") != null)
/* 1940 */       return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#145f758");
/* 1941 */     nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
/* 1942 */     context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#145f758", bean);
...
/* 2179 */       return (nc.ui.arap.actions.BillEditAction)context.get("editAction");
/* 2180 */     nc.ui.arap.actions.BillEditAction bean = new nc.ui.arap.actions.BillEditAction();
...
/* 2481 */     bean.setTpaProgressUtil(getTPAProgressUtil_71d2dc());
/* 2482 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 2483 */     invokeInitializingBean(bean);
/* 2484 */     return bean;
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_71d2dc() {
/* 2488 */     if (context.get("nc.ui.uif2.components.progress.TPAProgressUtil#71d2dc") != null)
/* 2489 */       return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#71d2dc");
/* 2490 */     nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
/* 2491 */     context.put("nc.ui.uif2.components.progress.TPAProgressUtil#71d2dc", bean);
...
/* 2521 */     bean.setTpaProgressUtil(getTPAProgressUtil_ca6edf());
/* 2522 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 2523 */     invokeInitializingBean(bean);
/* 2524 */     return bean;
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_ca6edf() {
/* 2528 */     if (context.get("nc.ui.uif2.components.progress.TPAProgressUtil#ca6edf") != null)
/* 2529 */       return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#ca6edf");
/* 2530 */     nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
/* 2531 */     context.put("nc.ui.uif2.components.progress.TPAProgressUtil#ca6edf", bean);
...
/* 2758 */     bean.setName(getI18nFB_350e93());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_350e93() {
/* 2766 */     if (context.get("nc.ui.uif2.I18nFB#350e93") != null)
/* 2767 */       return (String)context.get("nc.ui.uif2.I18nFB#350e93");
/* 2768 */     I18nFB bean = new I18nFB();
/* 2769 */     context.put("&nc.ui.uif2.I18nFB#350e93", bean);bean.setResDir("common");
...
/* 2776 */       context.put("nc.ui.uif2.I18nFB#350e93", product);
/* 2777 */       return (String)product;
/*      */     } catch (Exception e) {
/* 2779 */       throw new RuntimeException(e); } }
/*      */   
/* 2781 */   private List getManagedList19() { List list = new ArrayList();list.add(getDeleteAction());list.add(getEditAction());list.add(getTempSaveAction());list.add(getWriteBack());list.add(getDocumentManage());return list;
/*      */   }
/*      */   
...
/* 2789 */     bean.setName(getI18nFB_14fe777());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_14fe777() {
/* 2797 */     if (context.get("nc.ui.uif2.I18nFB#14fe777") != null)
/* 2798 */       return (String)context.get("nc.ui.uif2.I18nFB#14fe777");
/* 2799 */     I18nFB bean = new I18nFB();
/* 2800 */     context.put("&nc.ui.uif2.I18nFB#14fe777", bean);bean.setResDir("common");
...
/* 2807 */       context.put("nc.ui.uif2.I18nFB#14fe777", product);
...
/* 2820 */     bean.setName(getI18nFB_e54195());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_e54195() {
/* 2828 */     if (context.get("nc.ui.uif2.I18nFB#e54195") != null)
/* 2829 */       return (String)context.get("nc.ui.uif2.I18nFB#e54195");
/* 2830 */     I18nFB bean = new I18nFB();
/* 2831 */     context.put("&nc.ui.uif2.I18nFB#e54195", bean);bean.setResDir("common");
...
/* 2838 */       context.put("nc.ui.uif2.I18nFB#e54195", product);
...
/* 2851 */     bean.setName(getI18nFB_134de48());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_134de48() {
/* 2859 */     if (context.get("nc.ui.uif2.I18nFB#134de48") != null)
/* 2860 */       return (String)context.get("nc.ui.uif2.I18nFB#134de48");
/* 2861 */     I18nFB bean = new I18nFB();
/* 2862 */     context.put("&nc.ui.uif2.I18nFB#134de48", bean);bean.setResDir("common");
...
/* 2869 */       context.put("nc.ui.uif2.I18nFB#134de48", product);
...
/* 2882 */     bean.setName(getI18nFB_1ed8930());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_1ed8930() {
/* 2890 */     if (context.get("nc.ui.uif2.I18nFB#1ed8930") != null)
/* 2891 */       return (String)context.get("nc.ui.uif2.I18nFB#1ed8930");
/* 2892 */     I18nFB bean = new I18nFB();
/* 2893 */     context.put("&nc.ui.uif2.I18nFB#1ed8930", bean);bean.setResDir("common");
...
/* 2900 */       context.put("nc.ui.uif2.I18nFB#1ed8930", product);
...
/* 2913 */     bean.setName(getI18nFB_1c9bb9c());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_1c9bb9c() {
/* 2921 */     if (context.get("nc.ui.uif2.I18nFB#1c9bb9c") != null)
/* 2922 */       return (String)context.get("nc.ui.uif2.I18nFB#1c9bb9c");
/* 2923 */     I18nFB bean = new I18nFB();
/* 2924 */     context.put("&nc.ui.uif2.I18nFB#1c9bb9c", bean);bean.setResDir("common");
...
/* 2931 */       context.put("nc.ui.uif2.I18nFB#1c9bb9c", product);
...
/* 2944 */     bean.setName(getI18nFB_13c1c67());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_13c1c67() {
/* 2952 */     if (context.get("nc.ui.uif2.I18nFB#13c1c67") != null)
/* 2953 */       return (String)context.get("nc.ui.uif2.I18nFB#13c1c67");
/* 2954 */     I18nFB bean = new I18nFB();
/* 2955 */     context.put("&nc.ui.uif2.I18nFB#13c1c67", bean);bean.setResDir("common");
...
/* 2962 */       context.put("nc.ui.uif2.I18nFB#13c1c67", product);
...
/* 2975 */     bean.setName(getI18nFB_16ce531());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_16ce531() {
/* 2983 */     if (context.get("nc.ui.uif2.I18nFB#16ce531") != null)
/* 2984 */       return (String)context.get("nc.ui.uif2.I18nFB#16ce531");
/* 2985 */     I18nFB bean = new I18nFB();
/* 2986 */     context.put("&nc.ui.uif2.I18nFB#16ce531", bean);bean.setResDir("common");
...
/* 2993 */       context.put("nc.ui.uif2.I18nFB#16ce531", product);
...
/* 3006 */     bean.setName(getI18nFB_3b1064());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_3b1064() {
/* 3014 */     if (context.get("nc.ui.uif2.I18nFB#3b1064") != null)
/* 3015 */       return (String)context.get("nc.ui.uif2.I18nFB#3b1064");
/* 3016 */     I18nFB bean = new I18nFB();
/* 3017 */     context.put("&nc.ui.uif2.I18nFB#3b1064", bean);bean.setResDir("2006pub_0");
...
/* 3024 */       context.put("nc.ui.uif2.I18nFB#3b1064", product);
...
/* 3037 */     bean.setName(getI18nFB_1b13d5c());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_1b13d5c() {
/* 3045 */     if (context.get("nc.ui.uif2.I18nFB#1b13d5c") != null)
/* 3046 */       return (String)context.get("nc.ui.uif2.I18nFB#1b13d5c");
/* 3047 */     I18nFB bean = new I18nFB();
/* 3048 */     context.put("&nc.ui.uif2.I18nFB#1b13d5c", bean);bean.setResDir("common");
...
/* 3055 */       context.put("nc.ui.uif2.I18nFB#1b13d5c", product);
...
/* 3068 */     bean.setName(getI18nFB_13366f6());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_13366f6() {
/* 3076 */     if (context.get("nc.ui.uif2.I18nFB#13366f6") != null)
/* 3077 */       return (String)context.get("nc.ui.uif2.I18nFB#13366f6");
/* 3078 */     I18nFB bean = new I18nFB();
/* 3079 */     context.put("&nc.ui.uif2.I18nFB#13366f6", bean);bean.setResDir("common");
...
/* 3086 */       context.put("nc.ui.uif2.I18nFB#13366f6", product);
...
/* 3099 */     bean.setName(getI18nFB_bd7202());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_bd7202() {
/* 3107 */     if (context.get("nc.ui.uif2.I18nFB#bd7202") != null)
/* 3108 */       return (String)context.get("nc.ui.uif2.I18nFB#bd7202");
/* 3109 */     I18nFB bean = new I18nFB();
/* 3110 */     context.put("&nc.ui.uif2.I18nFB#bd7202", bean);bean.setResDir("pubapp_0");
...
/* 3210 */     bean.setName(getI18nFB_10acac9());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_10acac9() {
/* 3218 */     if (context.get("nc.ui.uif2.I18nFB#10acac9") != null)
/* 3219 */       return (String)context.get("nc.ui.uif2.I18nFB#10acac9");
/* 3220 */     I18nFB bean = new I18nFB();
/* 3221 */     context.put("&nc.ui.uif2.I18nFB#10acac9", bean);bean.setResDir("common");
...
/* 3228 */       context.put("nc.ui.uif2.I18nFB#10acac9", product);
...
/* 3238 */     String bean = new String("money_cr");context.put("defMoneyField", bean);
...
/* 3247 */     String bean = new String("F1");context.put("defBillType", bean);
...
/* 3256 */     String bean = new String("D1");context.put("defNodeKey", bean);
...
/* 3265 */     String bean = new String("arap.payablebill");context.put("mdFullnameHead", bean);
...
/* 3274 */     String bean = new String("arap.payableitem");context.put("mdFullnameBody", bean);
...
/* 3282 */       return (nc.ui.arap.actions.PayableLineDefValUtil)context.get("iArapLineDefValUtil");
/* 3283 */     nc.ui.arap.actions.PayableLineDefValUtil bean = new nc.ui.arap.actions.PayableLineDefValUtil();
...
/* 3292 */       return (nc.ui.arap.model.PayableBillAppModelService)context.get("ManageModelService");
/* 3293 */     nc.ui.arap.model.PayableBillAppModelService bean = new nc.ui.arap.model.PayableBillAppModelService();
...
/* 3301 */     if (context.get("paginationQueryService") != null)
/* 3302 */       return (nc.ui.arap.model.PayableBillPaginationQueryService)context.get("paginationQueryService");
/* 3303 */     nc.ui.arap.model.PayableBillPaginationQueryService bean = new nc.ui.arap.model.PayableBillPaginationQueryService();
/* 3304 */     context.put("paginationQueryService", bean);
/* 3305 */     bean.setPageSize(Integer.valueOf(10));
...
/* 3312 */     if (context.get("billDefVauleItf") != null)
/* 3313 */       return (nc.ui.arap.view.PayableBillDefValue)context.get("billDefVauleItf");
/* 3314 */     nc.ui.arap.view.PayableBillDefValue bean = new nc.ui.arap.view.PayableBillDefValue();
/* 3315 */     context.put("billDefVauleItf", bean);
/* 3316 */     bean.setEditor(getBillFormEditor());
...
/* 3323 */     if (context.get("calFldsItf") != null)
/* 3324 */       return (nc.ui.arap.viewhandler.CreditBillCalculatorFields)context.get("calFldsItf");
/* 3325 */     nc.ui.arap.viewhandler.CreditBillCalculatorFields bean = new nc.ui.arap.viewhandler.CreditBillCalculatorFields();
/* 3326 */     context.put("calFldsItf", bean);
...
/* 3333 */     if (context.get("transtype") != null)
/* 3334 */       return (nc.ui.arap.actions.TransTypeAction)context.get("transtype");
/* 3335 */     nc.ui.arap.actions.TransTypeAction bean = new nc.ui.arap.actions.TransTypeAction();
/* 3336 */     context.put("transtype", bean);
/* 3337 */     bean.setEditor(getBillFormEditor());
/* 3338 */     bean.setModel(getManageAppModel());
/* 3339 */     bean.setTransTypeRefModel(getTransTypeRefModel());
/* 3340 */     bean.setWherepart(" bd_billtype.parentbilltype ='F1' and pk_group != 'global00000000000000'");
...
/* 3347 */     if (context.get("saveActionReal") != null)
/* 3348 */       return (nc.ui.arap.actions.BillSaveAction)context.get("saveActionReal");
/* 3349 */     nc.ui.arap.actions.BillSaveAction bean = new nc.ui.arap.actions.BillSaveAction();
/* 3350 */     context.put("saveActionReal", bean);
/* 3351 */     bean.setModel(getManageAppModel());
/* 3352 */     bean.setEditor(getBillFormEditor());
/* 3353 */     bean.setInterceptor(getInterceptor());
/* 3354 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3355 */     invokeInitializingBean(bean);
/* 3356 */     return bean;
/*      */   }
			// libin
...
/* 3360 */     if (context.get("AppEventHandlerMediator") != null)
/* 3361 */       return (nc.ui.pubapp.uif2app.model.AppEventHandlerMediator)context.get("AppEventHandlerMediator");
/* 3362 */     nc.ui.pubapp.uif2app.model.AppEventHandlerMediator bean = new nc.ui.pubapp.uif2app.model.AppEventHandlerMediator();
/* 3363 */     context.put("AppEventHandlerMediator", bean);
/* 3364 */     bean.setModel(getManageAppModel());
/* 3365 */     bean.setHandlerMap(getManagedMap1());
/* 3366 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3367 */     invokeInitializingBean(bean);
/* 3368 */     return bean;
/*      */   }
/*      */   
/* 3371 */   private Map getManagedMap1() { Map map = new java.util.HashMap();map.put("nc.ui.pubapp.uif2app.event.card.CardBodyBeforeEditEvent", getManagedList32());map.put("nc.ui.pubapp.uif2app.event.card.CardBodyAfterEditEvent", getManagedList33());map.put("nc.ui.arap.viewhandler.CardBodyAfterEditEvent", getManagedList34());map.put("nc.ui.pubapp.uif2app.event.card.CardHeadTailBeforeEditEvent", getManagedList35());map.put("nc.ui.pubapp.uif2app.event.card.CardBodyAfterRowEditEvent", getManagedList36());map.put("nc.ui.pubapp.uif2app.event.card.CardHeadTailAfterEditEvent", getManagedList37());map.put("nc.ui.pubapp.uif2app.event.card.CardPanelLoadEvent", getManagedList38());map.put("nc.ui.pubapp.uif2app.event.card.CardBodyRowChangedEvent", getManagedList39());map.put("nc.ui.pubapp.uif2app.event.list.ListPanelLoadEvent", getManagedList40());map.put("nc.ui.pubapp.uif2app.event.list.ListHeadRowChangedEvent", getManagedList41());map.put("nc.ui.pubapp.uif2app.event.list.ListHeadDataChangedEvent", getManagedList42());map.put("nc.ui.pubapp.uif2app.mediator.mutiltrans.NodekeyEvent", getManagedList43());return map; }
/*      */   
/* 3373 */   private List getManagedList32() { List list = new ArrayList();list.add(getBodyBankAccBeforeEditHandler());list.add(getBodyAccountRefBeforeEditHandler());list.add(getBodyFreeCustBeforeEditHandler());list.add(getBodyProjectBeforeEditHandler());list.add(getBodyCrossCheckBeforeHandler());list.add(getBodySummaryBeforeEditHandler());list.add(getBodyVersionRefBeforeEditHandler());list.add(getOtherOrgBodyBeforeEditHandler());list.add(getBodyCostCenterRefBeforeEditHandler());list.add(getBodyTaxcodeBeforeEditHandler());list.add(getBodyPsnDocBeforeEditHandler());return list; }
/*      */   
/* 3375 */   private List getManagedList33() { List list = new ArrayList();list.add(getBodyAutoAddLineBeforeEditHandler());list.add(getBodyMaterialAfterEditHandler());list.add(getCardAfterEditCalculateHandler());list.add(getBodyPsnDocAfterEditHandler());list.add(getBodyCurrTypeAfterEditHandler());list.add(getBodyLocalMoneyAfterEditHandler());list.add(getBodyRateAfterEditHandler());list.add(getBodyEuroAfterEditHandler());list.add(getOtherOrgBodyAfterEditHandler());list.add(getBodyMoneyBalanceAfterEditHandler());list.add(getEnableCtrlBodyAfterEditHandler());list.add(getBodyFundplanAfterEditHandler());list.add(getBodyCuspAfterEditHandler());list.add(getBodyBankAccAfterEditHandler());list.add(getBodyDeptAfterEditHandler());list.add(getBodyVersionRefAfterEditHandler());list.add(getBodyCostCenterAfterEditHandler());list.add(getBodyDefRelationAfterEditHandler());return list; }
/*      */   
/* 3377 */   private List getManagedList34() { List list = new ArrayList();list.add(getBodyEuroAfterEditHandler());list.add(getBodyCuspAfterEditHandler());return list; }
/*      */   
/* 3379 */   private List getManagedList35() { List list = new ArrayList();list.add(getHeadBankAccBeforeEditHandler());list.add(getOtherOrgHeadBeforeEditHandler());list.add(getHeadCrossCheckBeforeHandler());list.add(getHeadSummaryBeforeEditHandler());list.add(getHeadVersionRefBeforeEditHandler());list.add(getHeadCostCenterRefBeforeEditHandler());list.add(getHeadAccountRefBeforeEditHandler());list.add(getHeadPsnDocBeforeEditHandler());return list; }
/*      */   
/* 3381 */   private List getManagedList36() { List list = new ArrayList();list.add(getCardBodyAfterRowEditHandler());return list; }
/*      */   
/* 3383 */   private List getManagedList37() { List list = new ArrayList();list.add(getHBRelationAfterEditHandler());list.add(getHeadCurrTypeAfterEditHandler());list.add(getHeadPsnDocAfterEditHandler());list.add(getOtherOrgHeadAfterEdithandler());list.add(getHeadFundplanAfterEditHandler());list.add(getObjTypeHeadAfterEdithandler());list.add(getHeadCuspAfterEditHandler());list.add(getHeadDeptAfterEditHandler());list.add(getHeadVersionRefAfterEditHandler());list.add(getHeadEuroAfterEditHandler());list.add(getHeadCostCenterAfterEditHandler());list.add(getHeadBillDateAfterEditHandler());list.add(getDefRelationAfterEditHandler());return list; }
/*      */   
/* 3385 */   private List getManagedList38() { List list = new ArrayList();list.add(getLoadBillCardTemplate());return list; }
/*      */   
/* 3387 */   private List getManagedList39() { List list = new ArrayList();list.add(getCardBodyRowChangeHandler());list.add(getSideFormMediator());return list; }
/*      */   
/* 3389 */   private List getManagedList40() { List list = new ArrayList();list.add(getLoadBillListTemplate());return list; }
/*      */   
/* 3391 */   private List getManagedList41() { List list = new ArrayList();list.add(getListHeadRowChangeListener());list.add(getSideFormMediator());return list; }
/*      */   
/* 3393 */   private List getManagedList42() { List list = new ArrayList();list.add(getListHeadModelListener());return list; }
/*      */   
/* 3395 */   private List getManagedList43() { List list = new ArrayList();list.add(getAddActionGroup());list.add(getTranstype());return list;
/*      */   }
/*      */   
/* 3398 */   public nc.vo.arappub.calculator.data.RelationItemForCal_Credit getRelationItemForCal() { if (context.get("relationItemForCal") != null)
/* 3399 */       return (nc.vo.arappub.calculator.data.RelationItemForCal_Credit)context.get("relationItemForCal");
/* 3400 */     nc.vo.arappub.calculator.data.RelationItemForCal_Credit bean = new nc.vo.arappub.calculator.data.RelationItemForCal_Credit();
/* 3401 */     context.put("relationItemForCal", bean);
/* 3402 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3403 */     invokeInitializingBean(bean);
/* 3404 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.viewhandler.DefRelationAfterEditHandler getDefRelationAfterEditHandler() {
/* 3408 */     if (context.get("DefRelationAfterEditHandler") != null)
/* 3409 */       return (nc.ui.arap.viewhandler.DefRelationAfterEditHandler)context.get("DefRelationAfterEditHandler");
/* 3410 */     nc.ui.arap.viewhandler.DefRelationAfterEditHandler bean = new nc.ui.arap.viewhandler.DefRelationAfterEditHandler();
/* 3411 */     context.put("DefRelationAfterEditHandler", bean);
/* 3412 */     bean.setBillform(getBillFormEditor());
/* 3413 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3414 */     invokeInitializingBean(bean);
/* 3415 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler getBodyDefRelationAfterEditHandler() {
/* 3419 */     if (context.get("BodyDefRelationAfterEditHandler") != null)
/* 3420 */       return (nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler)context.get("BodyDefRelationAfterEditHandler");
/* 3421 */     nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler bean = new nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler();
/* 3422 */     context.put("BodyDefRelationAfterEditHandler", bean);
/* 3423 */     bean.setBillform(getBillFormEditor());
/* 3424 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3425 */     invokeInitializingBean(bean);
/* 3426 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.listener.PayableBillRelationQueryDataListener getInitDataListener() {
/* 3430 */     if (context.get("InitDataListener") != null)
/* 3431 */       return (nc.ui.arap.listener.PayableBillRelationQueryDataListener)context.get("InitDataListener");
/* 3432 */     nc.ui.arap.listener.PayableBillRelationQueryDataListener bean = new nc.ui.arap.listener.PayableBillRelationQueryDataListener();
/* 3433 */     context.put("InitDataListener", bean);
/* 3434 */     bean.setBillFormEditor(getBillFormEditor());
/* 3435 */     bean.setListview(getListView());
/* 3436 */     bean.setContext(getContext());
/* 3437 */     bean.setModel(getManageAppModel());
/* 3438 */     bean.setVoClassName("nc.vo.arap.payable.AggPayableBillVO");
/* 3439 */     bean.setAutoShowUpComponent(getBillFormEditor());
/* 3440 */     bean.setQueryAction(getQueryAction());
/* 3441 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3442 */     invokeInitializingBean(bean);
/* 3443 */     return bean;
/*      */   }
/*      */   
/*      */   public MenuAction getBillAssistantActionGroup() {
/* 3447 */     if (context.get("billAssistantActionGroup") != null)
/* 3448 */       return (MenuAction)context.get("billAssistantActionGroup");
/* 3449 */     MenuAction bean = new MenuAction();
/* 3450 */     context.put("billAssistantActionGroup", bean);
/* 3451 */     bean.setCode("billAssistant");
/* 3452 */     bean.setName(getI18nFB_1879241());
/* 3453 */     bean.setActions(getManagedList44());
/* 3454 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3455 */     invokeInitializingBean(bean);
/* 3456 */     return bean;
/*      */   }
/*      */   
/*      */   private String getI18nFB_1879241() {
/* 3460 */     if (context.get("nc.ui.uif2.I18nFB#1879241") != null)
/* 3461 */       return (String)context.get("nc.ui.uif2.I18nFB#1879241");
/* 3462 */     I18nFB bean = new I18nFB();
/* 3463 */     context.put("&nc.ui.uif2.I18nFB#1879241", bean);bean.setResDir("2006pub_0");
/* 3464 */     bean.setResId("02006pub-0643");
/* 3465 */     bean.setDefaultValue("��������");
/* 3466 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3467 */     invokeInitializingBean(bean);
/*      */     try {
/* 3469 */       Object product = bean.getObject();
/* 3470 */       context.put("nc.ui.uif2.I18nFB#1879241", product);
/* 3471 */       return (String)product;
/*      */     } catch (Exception e) {
/* 3473 */       throw new RuntimeException(e); } }
/*      */   
/* 3475 */   private List getManagedList44() { List list = new ArrayList();list.add(getMakeAlterBill());list.add(getDocumentManage());return list;
/*      */   }
/*      */   
/* 3478 */   public MenuAction getBillAssistantActionGroup_List() { if (context.get("billAssistantActionGroup_List") != null)
/* 3479 */       return (MenuAction)context.get("billAssistantActionGroup_List");
/* 3480 */     MenuAction bean = new MenuAction();
/* 3481 */     context.put("billAssistantActionGroup_List", bean);
/* 3482 */     bean.setCode("billAssistant");
/* 3483 */     bean.setName(getI18nFB_1931231());
/* 3484 */     bean.setActions(getManagedList45());
/* 3485 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3486 */     invokeInitializingBean(bean);
/* 3487 */     return bean;
/*      */   }
/*      */   
/*      */   private String getI18nFB_1931231() {
/* 3491 */     if (context.get("nc.ui.uif2.I18nFB#1931231") != null)
/* 3492 */       return (String)context.get("nc.ui.uif2.I18nFB#1931231");
/* 3493 */     I18nFB bean = new I18nFB();
/* 3494 */     context.put("&nc.ui.uif2.I18nFB#1931231", bean);bean.setResDir("2006pub_0");
/* 3495 */     bean.setResId("02006pub-0643");
/* 3496 */     bean.setDefaultValue("��������");
/* 3497 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3498 */     invokeInitializingBean(bean);
/*      */     try {
/* 3500 */       Object product = bean.getObject();
/* 3501 */       context.put("nc.ui.uif2.I18nFB#1931231", product);
/* 3502 */       return (String)product;
/*      */     } catch (Exception e) {
/* 3504 */       throw new RuntimeException(e); } }
/*      */   
/* 3506 */   private List getManagedList45() { List list = new ArrayList();list.add(getDocumentManage());return list;
/*      */   }
/*      */   
/* 3509 */   public nc.ui.arap.importable.PayableRecordImportablePanel getImportableEditor() { if (context.get("importableEditor") != null)
/* 3510 */       return (nc.ui.arap.importable.PayableRecordImportablePanel)context.get("importableEditor");
/* 3511 */     nc.ui.arap.importable.PayableRecordImportablePanel bean = new nc.ui.arap.importable.PayableRecordImportablePanel();
/* 3512 */     context.put("importableEditor", bean);
/* 3513 */     bean.setUiEditor(getBillFormEditor());
...
/* 3520 */     if (context.get("importAction") != null)
/* 3521 */       return (nc.ui.arap.importable.action.ArapImportAction)context.get("importAction");
/* 3522 */     nc.ui.arap.importable.action.ArapImportAction bean = new nc.ui.arap.importable.action.ArapImportAction();
/* 3523 */     context.put("importAction", bean);
/* 3524 */     bean.setModel(getManageAppModel());
/* 3525 */     bean.setImportableEditor(getImportableEditor());
/* 3526 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3527 */     invokeInitializingBean(bean);
/* 3528 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.importable.ArapExportAction getExportAction() {
/* 3532 */     if (context.get("exportAction") != null)
/* 3533 */       return (nc.ui.arap.importable.ArapExportAction)context.get("exportAction");
/* 3534 */     nc.ui.arap.importable.ArapExportAction bean = new nc.ui.arap.importable.ArapExportAction();
/* 3535 */     context.put("exportAction", bean);
/* 3536 */     bean.setImportableEditor(getImportableEditor());
/* 3537 */     bean.setModel(getManageAppModel());
/* 3538 */     bean.setInterceptor(getExportActionInterceptor());
...
/* 3545 */     if (context.get("importexportActionGroup") != null)
/* 3546 */       return (MenuAction)context.get("importexportActionGroup");
/* 3547 */     MenuAction bean = new MenuAction();
/* 3548 */     context.put("importexportActionGroup", bean);
/* 3549 */     bean.setCode("ImportExportMenu");
/* 3550 */     bean.setName(getI18nFB_8f76c0());
/* 3551 */     bean.setActions(getManagedList46());
/* 3552 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3553 */     invokeInitializingBean(bean);
/* 3554 */     return bean;
/*      */   }
/*      */   
/*      */   private String getI18nFB_8f76c0() {
/* 3558 */     if (context.get("nc.ui.uif2.I18nFB#8f76c0") != null)
/* 3559 */       return (String)context.get("nc.ui.uif2.I18nFB#8f76c0");
/* 3560 */     I18nFB bean = new I18nFB();
/* 3561 */     context.put("&nc.ui.uif2.I18nFB#8f76c0", bean);bean.setResDir("2006pub_0");
/* 3562 */     bean.setResId("02006pub-0654");
/* 3563 */     bean.setDefaultValue("���뵼��");
/* 3564 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3565 */     invokeInitializingBean(bean);
/*      */     try {
/* 3567 */       Object product = bean.getObject();
/* 3568 */       context.put("nc.ui.uif2.I18nFB#8f76c0", product);
/* 3569 */       return (String)product;
/*      */     } catch (Exception e) {
/* 3571 */       throw new RuntimeException(e); } }
/*      */   
/* 3573 */   private List getManagedList46() { List list = new ArrayList();list.add(getImportAction());list.add(getCurrNullAction());list.add(getExportAction());return list;
/*      */   }
/*      */   
/* 3576 */   public nc.ui.uif2.actions.StandAloneToftPanelActionContainer getListActions() { if (context.get("listActions") != null)
/* 3577 */       return (nc.ui.uif2.actions.StandAloneToftPanelActionContainer)context.get("listActions");
/* 3578 */     nc.ui.uif2.actions.StandAloneToftPanelActionContainer bean = new nc.ui.uif2.actions.StandAloneToftPanelActionContainer(getListView());context.put("listActions", bean);
/* 3579 */     bean.setActions(getManagedList47());
/* 3580 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3581 */     invokeInitializingBean(bean);
/* 3582 */     return bean;
/*      */   }
/*      */   // ����ԭ���水ť��Ϊ �ύ��ť  list.add(getCommitAction())
/* 3585 */   private List getManagedList47() { List list = new ArrayList();list.add(getAddActionGroup());list.add(getEditAction());list.add(getDeleteAction());list.add(getCopyAction());list.add(getCurrNullAction());list.add(getQueryAction());list.add(getRefreshAllAction());list.add(getCurrNullAction());list.add(getTranstype());list.add(getBillAssistantActionGroup());list.add(getCurrNullAction());list.add(getReceiptMenuAction());list.add(getCurrNullAction());list.add(getRelatedQueryActionGroup());list.add(getCurrNullAction());list.add(getImportexportActionGroup());list.add(getPrintOperateActionGroup_List());return list;
/*      */   }
/*      */   
/* 3588 */   public nc.ui.uif2.actions.StandAloneToftPanelActionContainer getCardActions() { if (context.get("cardActions") != null)
/* 3589 */       return (nc.ui.uif2.actions.StandAloneToftPanelActionContainer)context.get("cardActions");
/* 3590 */     nc.ui.uif2.actions.StandAloneToftPanelActionContainer bean = new nc.ui.uif2.actions.StandAloneToftPanelActionContainer(getBillFormEditor());context.put("cardActions", bean);
/* 3591 */     bean.setActions(getManagedList48());
/* 3592 */     bean.setEditActions(getManagedList49());
/* 3593 */     bean.setModel(getManageAppModel());
/* 3594 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3595 */     invokeInitializingBean(bean);
/* 3596 */     return bean;
/*      */   }
/*      */   // libin ����ԭ���水ť��Ϊ �ύ��ť  list.add(getCommitAction())  list.add(getRecallAction())
/* 3599 */   private List getManagedList48() { List list = new ArrayList();list.add(getAddActionGroup());list.add(getEditAction());list.add(getDeleteAction()); list.add(getCommitAction());list.add(getRecallAction()) ;list.add(getCopyAction());list.add(getCurrNullAction());list.add(getQueryAction());list.add(getRefreshSingAction());list.add(getCurrNullAction());list.add(getTranstype());list.add(getBillAssistantActionGroup());list.add(getCurrNullAction());list.add(getReceiptMenuAction());list.add(getCurrNullAction());list.add(getRelatedQueryActionGroup());list.add(getCurrNullAction());list.add(getImportexportActionGroup());list.add(getPrintOperateActionGroup());return list; }
/*      */   
/* 3601 */   private List getManagedList49() { List list = new ArrayList();list.add(getSaveAction());list.add(getTempSaveAction());list.add(getCurrNullAction());list.add(getCancelAction());list.add(getCurrNullAction());list.add(getDocumentManage());list.add(getReceiptMenuAction());return list;
/*      */   }
/*      */ }

/* Location:           E:\work\Yonyou\home\sdgshome20201022\modules\arap\client\classes
 * Qualified Name:     nc.ui.arap.config.payablebill_record

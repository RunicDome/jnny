...
public class paybill_record_plan extends AbstractJavaBeanDefinition{
...
private List getManagedList0(){  List list = new ArrayList();  list.add(getQueryParam_445db0());  list.add(getQueryParam_1721138());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_445db0(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#445db0")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#445db0");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#445db0",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1721138(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1721138")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1721138");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1721138",bean);
...
public nc.ui.arap.view.ArapBillCardForm getBillFormEditor(){
 ...
 return (nc.ui.arap.view.ArapBillCardForm)context.get("billFormEditor");
  ...
  bean.setBlankChildrenFilter(getSingleFieldBlankChildrenFilter_1d76a79());
  bean.setDefValueItf(getBillDefVauleItf());
  bean.setBodyLineActions(getManagedList2());
  bean.setActions(getManagedList5());
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_1061e28());
  bean.initRealUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter getSingleFieldBlankChildrenFilter_1d76a79(){
 if(context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#1d76a79")!=null)
 return (nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter)context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#1d76a79");
  ...
  context.put("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#1d76a79",bean);
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getAddLineAction());  list.add(getInsertLineAction_68c14e());  list.add(getBodyDelLineAction_75b2ae());  list.add(getBodyCopyLineAction_1398949());  list.add(getBodyPasteLineAction_1a7a875());  list.add(getBodyPasteToTailAction_1bf7f3e());  list.add(getActionsBarSeparator());  list.add(getBodyLineEditAction_7a56a5());  list.add(getActionsBarSeparator());  list.add(getBillBodyZoomAction_1faeb62());  return list;}

private nc.ui.arap.actions.InsertLineAction getInsertLineAction_68c14e(){
 if(context.get("nc.ui.arap.actions.InsertLineAction#68c14e")!=null)
 return (nc.ui.arap.actions.InsertLineAction)context.get("nc.ui.arap.actions.InsertLineAction#68c14e");
  nc.ui.arap.actions.InsertLineAction bean = new nc.ui.arap.actions.InsertLineAction();
  context.put("nc.ui.arap.actions.InsertLineAction#68c14e",bean);
...
private nc.ui.arap.actions.BodyDelLineAction getBodyDelLineAction_75b2ae(){
 if(context.get("nc.ui.arap.actions.BodyDelLineAction#75b2ae")!=null)
 return (nc.ui.arap.actions.BodyDelLineAction)context.get("nc.ui.arap.actions.BodyDelLineAction#75b2ae");
  nc.ui.arap.actions.BodyDelLineAction bean = new nc.ui.arap.actions.BodyDelLineAction();
  context.put("nc.ui.arap.actions.BodyDelLineAction#75b2ae",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BodyCopyLineAction getBodyCopyLineAction_1398949(){
 if(context.get("nc.ui.arap.actions.BodyCopyLineAction#1398949")!=null)
 return (nc.ui.arap.actions.BodyCopyLineAction)context.get("nc.ui.arap.actions.BodyCopyLineAction#1398949");
  nc.ui.arap.actions.BodyCopyLineAction bean = new nc.ui.arap.actions.BodyCopyLineAction();
  context.put("nc.ui.arap.actions.BodyCopyLineAction#1398949",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BodyPasteLineAction getBodyPasteLineAction_1a7a875(){
 if(context.get("nc.ui.arap.actions.BodyPasteLineAction#1a7a875")!=null)
 return (nc.ui.arap.actions.BodyPasteLineAction)context.get("nc.ui.arap.actions.BodyPasteLineAction#1a7a875");
  nc.ui.arap.actions.BodyPasteLineAction bean = new nc.ui.arap.actions.BodyPasteLineAction();
  context.put("nc.ui.arap.actions.BodyPasteLineAction#1a7a875",bean);
...
private nc.ui.arap.actions.BodyPasteToTailAction getBodyPasteToTailAction_1bf7f3e(){
 if(context.get("nc.ui.arap.actions.BodyPasteToTailAction#1bf7f3e")!=null)
 return (nc.ui.arap.actions.BodyPasteToTailAction)context.get("nc.ui.arap.actions.BodyPasteToTailAction#1bf7f3e");
  nc.ui.arap.actions.BodyPasteToTailAction bean = new nc.ui.arap.actions.BodyPasteToTailAction();
  context.put("nc.ui.arap.actions.BodyPasteToTailAction#1bf7f3e",bean);
...
private nc.ui.arap.actions.BodyLineEditAction getBodyLineEditAction_7a56a5(){
 if(context.get("nc.ui.arap.actions.BodyLineEditAction#7a56a5")!=null)
 return (nc.ui.arap.actions.BodyLineEditAction)context.get("nc.ui.arap.actions.BodyLineEditAction#7a56a5");
  nc.ui.arap.actions.BodyLineEditAction bean = new nc.ui.arap.actions.BodyLineEditAction();
  context.put("nc.ui.arap.actions.BodyLineEditAction#7a56a5",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.arap.actions.BillBodyZoomAction getBillBodyZoomAction_1faeb62(){
 if(context.get("nc.ui.arap.actions.BillBodyZoomAction#1faeb62")!=null)
 return (nc.ui.arap.actions.BillBodyZoomAction)context.get("nc.ui.arap.actions.BillBodyZoomAction#1faeb62");
  nc.ui.arap.actions.BillBodyZoomAction bean = new nc.ui.arap.actions.BillBodyZoomAction();
  context.put("nc.ui.arap.actions.BillBodyZoomAction#1faeb62",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_1061e28(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#1061e28")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#1061e28");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#1061e28",bean);
  bean.setContainer(getUserdefitemContainer());
...
private Map getManagedMap0(){  Map map = new HashMap();  map.put(getI18nFB_15388ac(),getManagedList8());  map.put(getI18nFB_12125b7(),getManagedList9());  return map;}

private java.lang.String getI18nFB_15388ac(){
 if(context.get("nc.ui.uif2.I18nFB#15388ac")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#15388ac");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#15388ac",bean);  bean.setResDir("uif2");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#15388ac",product);
...
private java.lang.String getI18nFB_12125b7(){
 if(context.get("nc.ui.uif2.I18nFB#12125b7")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#12125b7");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#12125b7",bean);  bean.setResDir("uif2");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#12125b7",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_f0f913(){
 if(context.get("nc.ui.uif2.I18nFB#f0f913")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#f0f913");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#f0f913",bean);  bean.setResDir("pubapp_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#f0f913",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_1087453());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_1087453(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#1087453")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#1087453");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#1087453",bean);
...
private List getManagedList13(){  List list = new ArrayList();  list.add(getVSNode_c5c684());  list.add(getHSNode_167eb46());  list.add(getCNode_1763cbc());  list.add(getCNode_158272d());  return list;}

private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_c5c684(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#c5c684")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#c5c684");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#c5c684",bean);
  bean.setUp(getCNode_3b6617());
  bean.setDown(getCNode_d28177());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_3b6617(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#3b6617")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#3b6617");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#3b6617",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_d28177(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#d28177")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#d28177");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#d28177",bean);
  bean.setName(getI18nFB_18ba700());
...
private java.lang.String getI18nFB_18ba700(){
 if(context.get("nc.ui.uif2.I18nFB#18ba700")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#18ba700");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#18ba700",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#18ba700",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_167eb46(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#167eb46")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#167eb46");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#167eb46",bean);
  bean.setLeft(getCNode_1ef0d55());
  bean.setRight(getVSNode_74d47c());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1ef0d55(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1ef0d55")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1ef0d55");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1ef0d55",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_74d47c(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#74d47c")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#74d47c");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#74d47c",bean);
  bean.setUp(getCNode_15003cf());
  bean.setDown(getCNode_158eb27());
  bean.setShowMode("NoDivider");
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_15003cf(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#15003cf")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#15003cf");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#15003cf",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_158eb27(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#158eb27")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#158eb27");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#158eb27",bean);
  bean.setName(getI18nFB_177f82b());
...
private java.lang.String getI18nFB_177f82b(){
 if(context.get("nc.ui.uif2.I18nFB#177f82b")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#177f82b");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#177f82b",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#177f82b",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_1763cbc(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1763cbc")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1763cbc");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1763cbc",bean);
  bean.setName(getI18nFB_14dfce1());
...
private java.lang.String getI18nFB_14dfce1(){
 if(context.get("nc.ui.uif2.I18nFB#14dfce1")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#14dfce1");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#14dfce1",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#14dfce1",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_158272d(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#158272d")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#158272d");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#158272d",bean);
  bean.setName(getI18nFB_153ca1a());
...
private java.lang.String getI18nFB_153ca1a(){
 if(context.get("nc.ui.uif2.I18nFB#153ca1a")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#153ca1a");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#153ca1a",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#153ca1a",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList14(){  List list = new ArrayList();  list.add(getDocumentManage());  list.add(getActionsBarSeparator());  list.add(getFirstLineAction());  list.add(getPreLineAction());  list.add(getNextLineAction());  list.add(getLastLineAction());  list.add(getActionsBarSeparator());  list.add(getBillHeadZoomAction_1cfe600());  return list;}

private nc.ui.arap.actions.BillHeadZoomAction getBillHeadZoomAction_1cfe600(){
 if(context.get("nc.ui.arap.actions.BillHeadZoomAction#1cfe600")!=null)
 return (nc.ui.arap.actions.BillHeadZoomAction)context.get("nc.ui.arap.actions.BillHeadZoomAction#1cfe600");
  nc.ui.arap.actions.BillHeadZoomAction bean = new nc.ui.arap.actions.BillHeadZoomAction();
  context.put("nc.ui.arap.actions.BillHeadZoomAction#1cfe600",bean);
  bean.setModel(getManageAppModel());
  bean.setBillForm(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.ui.arap.view.ArapBillCardForm getMakeupEditor(){
 ...
 return (nc.ui.arap.view.ArapBillCardForm)context.get("makeupEditor");
  ...
  bean.setAutoAddLine(false);
  bean.setTemplateNotNullValidate(true);
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_e56c00());
  bean.initRealUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_e56c00(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#e56c00")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#e56c00");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#e56c00",bean);
  bean.setContainer(getUserdefitemContainer());
...
public nc.ui.arap.actions.GCFKSaveAction getSaveAction(){
 if(context.get("saveAction")!=null)
 return (nc.ui.arap.actions.GCFKSaveAction)context.get("saveAction");
  nc.ui.arap.actions.GCFKSaveAction bean = new nc.ui.arap.actions.GCFKSaveAction(getSaveActionReal());  context.put("saveAction",bean);
  bean.setModel(getManageAppModel());
  bean.setEditor(getBillFormEditor());
  bean.setInterceptor(getInterceptor());
setBeanFacotryIfBeanFacatoryAware(bean);
...
public nc.ui.arap.actions.BillListApproveAction getApproveListBatchAction(){
 ...
 return (nc.ui.arap.actions.BillListApproveAction)context.get("ApproveListBatchAction");
  ...
  bean.setIsbatch("Y");
  bean.setInterceptor(getInterceptor());
  bean.setTpaProgressUtil(getTPAProgressUtil_43f6e4());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_43f6e4(){
 if(context.get("nc.ui.uif2.components.progress.TPAProgressUtil#43f6e4")!=null)
 return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#43f6e4");
  nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
  context.put("nc.ui.uif2.components.progress.TPAProgressUtil#43f6e4",bean);
  bean.setContext(getContext());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.arap.actions.BillListApproveAction getApproveListAction(){
 ...
 return (nc.ui.arap.actions.BillListApproveAction)context.get("ApproveListAction");
  ...
  bean.setIsbatch("N");
  bean.setInterceptor(getInterceptor());
  bean.setTpaProgressUtil(getTPAProgressUtil_e7362a());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_e7362a(){
 if(context.get("nc.ui.uif2.components.progress.TPAProgressUtil#e7362a")!=null)
 return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#e7362a");
  nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
  context.put("nc.ui.uif2.components.progress.TPAProgressUtil#e7362a",bean);
  bean.setContext(getContext());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_8535fc(){
 if(context.get("nc.ui.uif2.I18nFB#8535fc")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#8535fc");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#8535fc",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#8535fc",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getBillOperateActionGroup_Record(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billOperateActionGroup_Record");
  ...
  bean.setCode("billOperate");
  bean.setName(getI18nFB_196c9b0());
...
private java.lang.String getI18nFB_196c9b0(){
 if(context.get("nc.ui.uif2.I18nFB#196c9b0")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#196c9b0");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#196c9b0",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#196c9b0",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_c9e670(){
 if(context.get("nc.ui.uif2.I18nFB#c9e670")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#c9e670");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#c9e670",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#c9e670",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getBillOperateActionGroup_List(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billOperateActionGroup_List");
  ...
  bean.setName(getI18nFB_1c2cea5());
...
private java.lang.String getI18nFB_1c2cea5(){
 if(context.get("nc.ui.uif2.I18nFB#1c2cea5")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1c2cea5");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1c2cea5",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0137");
  bean.setDefaultValue("单据操作");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1c2cea5",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_a5046e(){
 if(context.get("nc.ui.uif2.I18nFB#a5046e")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#a5046e");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#a5046e",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#a5046e",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getBillApproveActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("billApproveActionGroup");
  ...
  bean.setName(getI18nFB_1a78603());
...
private java.lang.String getI18nFB_1a78603(){
 if(context.get("nc.ui.uif2.I18nFB#1a78603")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1a78603");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1a78603",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1a78603",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_d611a1(){
 if(context.get("nc.ui.uif2.I18nFB#d611a1")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#d611a1");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#d611a1",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0142");
  bean.setDefaultValue("审批");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#d611a1",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getBillVerifyActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("billVerifyActionGroup");
  ...
  bean.setName(getI18nFB_1ee5a38());
...
private java.lang.String getI18nFB_1ee5a38(){
 if(context.get("nc.ui.uif2.I18nFB#1ee5a38")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1ee5a38");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1ee5a38",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1ee5a38",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.GroupAction getPauseTransactActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("pauseTransactActionGroup");
  ...
  bean.setName(getI18nFB_1c4a31f());
...
private java.lang.String getI18nFB_1c4a31f(){
 if(context.get("nc.ui.uif2.I18nFB#1c4a31f")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1c4a31f");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1c4a31f",bean);  bean.setResDir("2006pub_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1c4a31f",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_32b43a(){
 if(context.get("nc.ui.uif2.I18nFB#32b43a")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#32b43a");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#32b43a",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#32b43a",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_fe404(){
 if(context.get("nc.ui.uif2.I18nFB#fe404")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#fe404");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#fe404",bean);  bean.setResDir("common");
  bean.setResId("arapcommonv6-0139");
  bean.setDefaultValue("打印");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#fe404",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getRelatedQueryActionGroup(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("relatedQueryActionGroup");
  ...
  bean.setName(getI18nFB_136b76e());
...
private java.lang.String getI18nFB_136b76e(){
 if(context.get("nc.ui.uif2.I18nFB#136b76e")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#136b76e");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#136b76e",bean);  bean.setResDir("pubapp_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#136b76e",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.funcnode.ui.action.MenuAction getReceiptMenuAction(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("receiptMenuAction");
  ...
  bean.setCode("Image");
  bean.setName(getI18nFB_117c380());
...
private java.lang.String getI18nFB_117c380(){
 if(context.get("nc.ui.uif2.I18nFB#117c380")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#117c380");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#117c380",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#117c380",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.arap.viewhandler.DefRelationAfterEditHandler getDefRelationAfterEditHandler(){
 if(context.get("DefRelationAfterEditHandler")!=null)
 return (nc.ui.arap.viewhandler.DefRelationAfterEditHandler)context.get("DefRelationAfterEditHandler");
  nc.ui.arap.viewhandler.DefRelationAfterEditHandler bean = new nc.ui.arap.viewhandler.DefRelationAfterEditHandler();
  context.put("DefRelationAfterEditHandler",bean);
  bean.setBillform(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler getBodyDefRelationAfterEditHandler(){
 if(context.get("BodyDefRelationAfterEditHandler")!=null)
 return (nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler)context.get("BodyDefRelationAfterEditHandler");
  nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler bean = new nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler();
  context.put("BodyDefRelationAfterEditHandler",bean);
  bean.setBillform(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.arap.viewhandler.cardafter.BodyMoneyAfterEditHandler getBodyMoneyAfterEditHandler(){
 if(context.get("BodyMoneyAfterEditHandler")!=null)
 return (nc.ui.arap.viewhandler.cardafter.BodyMoneyAfterEditHandler)context.get("BodyMoneyAfterEditHandler");
  nc.ui.arap.viewhandler.cardafter.BodyMoneyAfterEditHandler bean = new nc.ui.arap.viewhandler.cardafter.BodyMoneyAfterEditHandler();
  context.put("BodyMoneyAfterEditHandler",bean);
  bean.setModel(getManageAppModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.funcnode.ui.action.MenuAction getBillAssistantActionGroup(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("billAssistantActionGroup");
  ...
  bean.setName(getI18nFB_127df2c());
...
private java.lang.String getI18nFB_127df2c(){
 if(context.get("nc.ui.uif2.I18nFB#127df2c")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#127df2c");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#127df2c",bean);  bean.setResDir("2006pub_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#127df2c",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private java.lang.String getI18nFB_c04c08(){
 if(context.get("nc.ui.uif2.I18nFB#c04c08")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#c04c08");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#c04c08",bean);  bean.setResDir("2006pub_0");
  bean.setResId("02006pub-0643");
  bean.setDefaultValue("辅助功能");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#c04c08",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList45(){  List list = new ArrayList();  list.add(getDocumentManage());  list.add(getAssociateSettInfoAction());  return list;}
...
public nc.funcnode.ui.action.GroupAction getBillCommissionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("billCommissionGroup");
  ...
  bean.setName(getI18nFB_17c9493());
...
private java.lang.String getI18nFB_17c9493(){
 if(context.get("nc.ui.uif2.I18nFB#17c9493")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#17c9493");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#17c9493",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#17c9493",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList46(){  List list = new ArrayList();  list.add(getBillCommisionPaySaveAction());  list.add(getBillCancelCommisionPayAction());  return list;}
...
public nc.funcnode.ui.action.MenuAction getImportexportActionGroup(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("importexportActionGroup");
  ...
  bean.setName(getI18nFB_1120e08());
...
private java.lang.String getI18nFB_1120e08(){
 if(context.get("nc.ui.uif2.I18nFB#1120e08")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1120e08");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1120e08",bean);  bean.setResDir("2006pub_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1120e08",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList47(){  List list = new ArrayList();  list.add(getImportAction());  list.add(getCurrNullAction());  list.add(getExportAction());  return list;}
...
private List getManagedList49(){  List list = new ArrayList();  list.add(getAddActionGroup());  list.add(getEditAction());  list.add(getDeleteAction());  list.add(getCopyAction());  list.add(getCurrNullAction());  list.add(getCommitAction());  list.add(getRecallAction());  list.add(getCurrNullAction());  list.add(getQueryAction());  list.add(getRefreshSingAction());  list.add(getCurrNullAction());  list.add(getTranstype());  list.add(getBillAssistantActionGroup());  list.add(getCurrNullAction());  list.add(getReceiptMenuAction());  list.add(getCurrNullAction());  list.add(getRelatedQueryActionGroup());  list.add(getCurrNullAction());  list.add(getImportexportActionGroup());  list.add(getPrintOperateActionGroup());  return list;}

private List getManagedList50(){  List list = new ArrayList();  list.add(getSaveAction());  list.add(getTempSaveAction());  list.add(getCurrNullAction());  list.add(getCancelAction());  list.add(getCurrNullAction());  list.add(getDocumentManage());  list.add(getReceiptMenuAction());  return list;}

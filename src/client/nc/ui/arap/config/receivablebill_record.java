...
/*      */ 
/*      */ public class receivablebill_record extends nc.ui.uif2.factory.AbstractJavaBeanDefinition
/*      */ {
...
/*      */   }
/*      */   
/*  146 */   private List getManagedList0() { List list = new ArrayList();list.add(getQueryParam_417ea4());list.add(getQueryParam_1e162f7());return list;
/*      */   }
/*      */   
/*  149 */   private nc.ui.uif2.userdefitem.QueryParam getQueryParam_417ea4() { if (context.get("nc.ui.uif2.userdefitem.QueryParam#417ea4") != null)
/*  150 */       return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#417ea4");
/*  151 */     nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
/*  152 */     context.put("nc.ui.uif2.userdefitem.QueryParam#417ea4", bean);
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1e162f7() {
/*  160 */     if (context.get("nc.ui.uif2.userdefitem.QueryParam#1e162f7") != null)
/*  161 */       return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1e162f7");
/*  162 */     nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
/*  163 */     context.put("nc.ui.uif2.userdefitem.QueryParam#1e162f7", bean);
...
/*  323 */     bean.setBlankChildrenFilter(getSingleFieldBlankChildrenFilter_28743a());
/*  324 */     bean.setDefValueItf(getBillDefVauleItf());
/*  325 */     bean.setBodyLineActions(getManagedList2());
/*  326 */     bean.setActions(getManagedList5());
/*  327 */     bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_ab7135());
/*  328 */     bean.initRealUI();
...
/*      */   }
/*      */   
/*      */   private nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter getSingleFieldBlankChildrenFilter_28743a() {
/*  335 */     if (context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#28743a") != null)
/*  336 */       return (nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter)context.get("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#28743a");
...
/*  338 */     context.put("nc.ui.pubapp.uif2app.view.value.SingleFieldBlankChildrenFilter#28743a", bean);
...
/*      */   }
/*      */   
/*  345 */   private List getManagedList2() { List list = new ArrayList();list.add(getAddLineAction());list.add(getInsertLineAction_1e6bb1a());list.add(getBodyDelLineAction_105db33());list.add(getBodyCopyLineAction_17a129e());list.add(getBodyPasteLineAction_15c7824());list.add(getBodyPasteToTailAction_1d3c4cf());list.add(getActionsBarSeparator());list.add(getBodyLineEditAction_1dfa27());list.add(getActionsBarSeparator());list.add(getBillBodyZoomAction_1222cf());return list;
/*      */   }
/*      */   
/*  348 */   private nc.ui.arap.actions.InsertLineAction getInsertLineAction_1e6bb1a() { if (context.get("nc.ui.arap.actions.InsertLineAction#1e6bb1a") != null)
/*  349 */       return (nc.ui.arap.actions.InsertLineAction)context.get("nc.ui.arap.actions.InsertLineAction#1e6bb1a");
/*  350 */     nc.ui.arap.actions.InsertLineAction bean = new nc.ui.arap.actions.InsertLineAction();
/*  351 */     context.put("nc.ui.arap.actions.InsertLineAction#1e6bb1a", bean);
...
/*      */   }
/*      */   
/*      */   private nc.ui.arap.actions.BodyDelLineAction getBodyDelLineAction_105db33() {
/*  361 */     if (context.get("nc.ui.arap.actions.BodyDelLineAction#105db33") != null)
/*  362 */       return (nc.ui.arap.actions.BodyDelLineAction)context.get("nc.ui.arap.actions.BodyDelLineAction#105db33");
/*  363 */     nc.ui.arap.actions.BodyDelLineAction bean = new nc.ui.arap.actions.BodyDelLineAction();
/*  364 */     context.put("nc.ui.arap.actions.BodyDelLineAction#105db33", bean);
/*  365 */     setBeanFacotryIfBeanFacatoryAware(bean);
/*  366 */     invokeInitializingBean(bean);
/*  367 */     return bean;
/*      */   }
/*      */   
/*      */   private nc.ui.arap.actions.BodyCopyLineAction getBodyCopyLineAction_17a129e() {
/*  371 */     if (context.get("nc.ui.arap.actions.BodyCopyLineAction#17a129e") != null)
/*  372 */       return (nc.ui.arap.actions.BodyCopyLineAction)context.get("nc.ui.arap.actions.BodyCopyLineAction#17a129e");
/*  373 */     nc.ui.arap.actions.BodyCopyLineAction bean = new nc.ui.arap.actions.BodyCopyLineAction();
/*  374 */     context.put("nc.ui.arap.actions.BodyCopyLineAction#17a129e", bean);
/*  375 */     setBeanFacotryIfBeanFacatoryAware(bean);
/*  376 */     invokeInitializingBean(bean);
/*  377 */     return bean;
/*      */   }
/*      */   
/*      */   private nc.ui.arap.actions.BodyPasteLineAction getBodyPasteLineAction_15c7824() {
/*  381 */     if (context.get("nc.ui.arap.actions.BodyPasteLineAction#15c7824") != null)
/*  382 */       return (nc.ui.arap.actions.BodyPasteLineAction)context.get("nc.ui.arap.actions.BodyPasteLineAction#15c7824");
/*  383 */     nc.ui.arap.actions.BodyPasteLineAction bean = new nc.ui.arap.actions.BodyPasteLineAction();
/*  384 */     context.put("nc.ui.arap.actions.BodyPasteLineAction#15c7824", bean);
...
/*      */   }
/*      */   
/*  395 */   private nc.ui.arap.actions.BodyPasteToTailAction getBodyPasteToTailAction_1d3c4cf() { if (context.get("nc.ui.arap.actions.BodyPasteToTailAction#1d3c4cf") != null)
/*  396 */       return (nc.ui.arap.actions.BodyPasteToTailAction)context.get("nc.ui.arap.actions.BodyPasteToTailAction#1d3c4cf");
/*  397 */     nc.ui.arap.actions.BodyPasteToTailAction bean = new nc.ui.arap.actions.BodyPasteToTailAction();
/*  398 */     context.put("nc.ui.arap.actions.BodyPasteToTailAction#1d3c4cf", bean);
...
/*      */   }
/*      */   
/*  409 */   private nc.ui.arap.actions.BodyLineEditAction getBodyLineEditAction_1dfa27() { if (context.get("nc.ui.arap.actions.BodyLineEditAction#1dfa27") != null)
/*  410 */       return (nc.ui.arap.actions.BodyLineEditAction)context.get("nc.ui.arap.actions.BodyLineEditAction#1dfa27");
/*  411 */     nc.ui.arap.actions.BodyLineEditAction bean = new nc.ui.arap.actions.BodyLineEditAction();
/*  412 */     context.put("nc.ui.arap.actions.BodyLineEditAction#1dfa27", bean);
/*  413 */     setBeanFacotryIfBeanFacatoryAware(bean);
/*  414 */     invokeInitializingBean(bean);
/*  415 */     return bean;
/*      */   }
/*      */   
/*      */   private nc.ui.arap.actions.BillBodyZoomAction getBillBodyZoomAction_1222cf() {
/*  419 */     if (context.get("nc.ui.arap.actions.BillBodyZoomAction#1222cf") != null)
/*  420 */       return (nc.ui.arap.actions.BillBodyZoomAction)context.get("nc.ui.arap.actions.BillBodyZoomAction#1222cf");
/*  421 */     nc.ui.arap.actions.BillBodyZoomAction bean = new nc.ui.arap.actions.BillBodyZoomAction();
/*  422 */     context.put("nc.ui.arap.actions.BillBodyZoomAction#1222cf", bean);
...
/*      */   }
/*      */   
/*  431 */   private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_ab7135() { if (context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#ab7135") != null)
/*  432 */       return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#ab7135");
/*  433 */     nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
/*  434 */     context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#ab7135", bean);
...
/* 1419 */     bean.setName(getI18nFB_1ebd1b6());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_1ebd1b6() {
/* 1427 */     if (context.get("nc.ui.uif2.I18nFB#1ebd1b6") != null)
/* 1428 */       return (String)context.get("nc.ui.uif2.I18nFB#1ebd1b6");
/* 1429 */     I18nFB bean = new I18nFB();
/* 1430 */     context.put("&nc.ui.uif2.I18nFB#1ebd1b6", bean);bean.setResDir("pubapp_0");
...
/* 1437 */       context.put("nc.ui.uif2.I18nFB#1ebd1b6", product);
...
/* 1567 */     bean.setTangramLayoutRoot(getTBNode_108196a());
/* 1568 */     bean.initUI();
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_108196a() {
/* 1575 */     if (context.get("nc.ui.uif2.tangramlayout.node.TBNode#108196a") != null)
/* 1576 */       return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#108196a");
/* 1577 */     nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
/* 1578 */     context.put("nc.ui.uif2.tangramlayout.node.TBNode#108196a", bean);
...
/*      */   }
/*      */   
/* 1586 */   private List getManagedList12() { List list = new ArrayList();list.add(getVSNode_16f896e());list.add(getHSNode_50ccb4());list.add(getCNode_129ad02());list.add(getCNode_f0579d());return list;
/*      */   }
/*      */   
/* 1589 */   private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_16f896e() { if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#16f896e") != null)
/* 1590 */       return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#16f896e");
/* 1591 */     nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
/* 1592 */     context.put("nc.ui.uif2.tangramlayout.node.VSNode#16f896e", bean);
/* 1593 */     bean.setUp(getCNode_17060d());
/* 1594 */     bean.setDown(getCNode_17ff40d());
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_17060d() {
/* 1603 */     if (context.get("nc.ui.uif2.tangramlayout.node.CNode#17060d") != null)
/* 1604 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#17060d");
/* 1605 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1606 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#17060d", bean);
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_17ff40d() {
/* 1614 */     if (context.get("nc.ui.uif2.tangramlayout.node.CNode#17ff40d") != null)
/* 1615 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#17ff40d");
/* 1616 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1617 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#17ff40d", bean);
/* 1618 */     bean.setName(getI18nFB_18e6ca9());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_18e6ca9() {
/* 1626 */     if (context.get("nc.ui.uif2.I18nFB#18e6ca9") != null)
/* 1627 */       return (String)context.get("nc.ui.uif2.I18nFB#18e6ca9");
/* 1628 */     I18nFB bean = new I18nFB();
/* 1629 */     context.put("&nc.ui.uif2.I18nFB#18e6ca9", bean);bean.setResDir("common");
...
/* 1636 */       context.put("nc.ui.uif2.I18nFB#18e6ca9", product);
/* 1637 */       return (String)product;
/*      */     } catch (Exception e) {
/* 1639 */       throw new RuntimeException(e);
/*      */     } }
/*      */   
/* 1642 */   private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_50ccb4() { if (context.get("nc.ui.uif2.tangramlayout.node.HSNode#50ccb4") != null)
/* 1643 */       return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#50ccb4");
/* 1644 */     nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
/* 1645 */     context.put("nc.ui.uif2.tangramlayout.node.HSNode#50ccb4", bean);
/* 1646 */     bean.setLeft(getCNode_1a7a1cd());
/* 1647 */     bean.setRight(getVSNode_17c8e08());
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_1a7a1cd() {
/* 1655 */     if (context.get("nc.ui.uif2.tangramlayout.node.CNode#1a7a1cd") != null)
/* 1656 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1a7a1cd");
/* 1657 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1658 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#1a7a1cd", bean);
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_17c8e08() {
/* 1666 */     if (context.get("nc.ui.uif2.tangramlayout.node.VSNode#17c8e08") != null)
/* 1667 */       return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#17c8e08");
/* 1668 */     nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
/* 1669 */     context.put("nc.ui.uif2.tangramlayout.node.VSNode#17c8e08", bean);
/* 1670 */     bean.setUp(getCNode_6fcfeb());
/* 1671 */     bean.setDown(getCNode_12e3875());
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_6fcfeb() {
/* 1680 */     if (context.get("nc.ui.uif2.tangramlayout.node.CNode#6fcfeb") != null)
/* 1681 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#6fcfeb");
/* 1682 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1683 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#6fcfeb", bean);
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_12e3875() {
/* 1691 */     if (context.get("nc.ui.uif2.tangramlayout.node.CNode#12e3875") != null)
/* 1692 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#12e3875");
/* 1693 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1694 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#12e3875", bean);
/* 1695 */     bean.setName(getI18nFB_bb8d20());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_bb8d20() {
/* 1703 */     if (context.get("nc.ui.uif2.I18nFB#bb8d20") != null)
/* 1704 */       return (String)context.get("nc.ui.uif2.I18nFB#bb8d20");
/* 1705 */     I18nFB bean = new I18nFB();
/* 1706 */     context.put("&nc.ui.uif2.I18nFB#bb8d20", bean);bean.setResDir("common");
...
/* 1713 */       context.put("nc.ui.uif2.I18nFB#bb8d20", product);
/* 1714 */       return (String)product;
/*      */     } catch (Exception e) {
/* 1716 */       throw new RuntimeException(e);
/*      */     } }
/*      */   
/* 1719 */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_129ad02() { if (context.get("nc.ui.uif2.tangramlayout.node.CNode#129ad02") != null)
/* 1720 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#129ad02");
/* 1721 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1722 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#129ad02", bean);
/* 1723 */     bean.setName(getI18nFB_af4dff());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_af4dff() {
/* 1731 */     if (context.get("nc.ui.uif2.I18nFB#af4dff") != null)
/* 1732 */       return (String)context.get("nc.ui.uif2.I18nFB#af4dff");
/* 1733 */     I18nFB bean = new I18nFB();
/* 1734 */     context.put("&nc.ui.uif2.I18nFB#af4dff", bean);bean.setResDir("common");
...
/* 1741 */       context.put("nc.ui.uif2.I18nFB#af4dff", product);
/* 1742 */       return (String)product;
/*      */     } catch (Exception e) {
/* 1744 */       throw new RuntimeException(e);
/*      */     } }
/*      */   
/* 1747 */   private nc.ui.uif2.tangramlayout.node.CNode getCNode_f0579d() { if (context.get("nc.ui.uif2.tangramlayout.node.CNode#f0579d") != null)
/* 1748 */       return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#f0579d");
/* 1749 */     nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
/* 1750 */     context.put("nc.ui.uif2.tangramlayout.node.CNode#f0579d", bean);
/* 1751 */     bean.setName(getI18nFB_11d6d43());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_11d6d43() {
/* 1759 */     if (context.get("nc.ui.uif2.I18nFB#11d6d43") != null)
/* 1760 */       return (String)context.get("nc.ui.uif2.I18nFB#11d6d43");
/* 1761 */     I18nFB bean = new I18nFB();
/* 1762 */     context.put("&nc.ui.uif2.I18nFB#11d6d43", bean);bean.setResDir("common");
...
/* 1769 */       context.put("nc.ui.uif2.I18nFB#11d6d43", product);
...
/*      */   }
/*      */   
/* 1810 */   private List getManagedList13() { List list = new ArrayList();list.add(getDocumentManage());list.add(getActionsBarSeparator());list.add(getFirstLineAction());list.add(getPreLineAction());list.add(getNextLineAction());list.add(getLastLineAction());list.add(getActionsBarSeparator());list.add(getBillHeadZoomAction_9304f0());return list;
/*      */   }
/*      */   
/* 1813 */   private nc.ui.arap.actions.BillHeadZoomAction getBillHeadZoomAction_9304f0() { if (context.get("nc.ui.arap.actions.BillHeadZoomAction#9304f0") != null)
/* 1814 */       return (nc.ui.arap.actions.BillHeadZoomAction)context.get("nc.ui.arap.actions.BillHeadZoomAction#9304f0");
/* 1815 */     nc.ui.arap.actions.BillHeadZoomAction bean = new nc.ui.arap.actions.BillHeadZoomAction();
/* 1816 */     context.put("nc.ui.arap.actions.BillHeadZoomAction#9304f0", bean);
...
/* 1895 */     bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_29383e());
...
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_29383e() {
/* 1903 */     if (context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#29383e") != null)
/* 1904 */       return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#29383e");
/* 1905 */     nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
/* 1906 */     context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#29383e", bean);
...
/* 2684 */     bean.setName(getI18nFB_16a0c9c());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_16a0c9c() {
/* 2692 */     if (context.get("nc.ui.uif2.I18nFB#16a0c9c") != null)
/* 2693 */       return (String)context.get("nc.ui.uif2.I18nFB#16a0c9c");
/* 2694 */     I18nFB bean = new I18nFB();
/* 2695 */     context.put("&nc.ui.uif2.I18nFB#16a0c9c", bean);bean.setResDir("common");
...
/* 2702 */       context.put("nc.ui.uif2.I18nFB#16a0c9c", product);
/* 2703 */       return (String)product;
/*      */     } catch (Exception e) {
/* 2705 */       throw new RuntimeException(e); } }
/*      */   
/* 2707 */   private List getManagedList18() { List list = new ArrayList();list.add(getDeleteAction());list.add(getEditAction());list.add(getTempSaveAction());list.add(getWriteBack());list.add(getDocumentManage());return list;
/*      */   }
/*      */   
...
/* 2715 */     bean.setName(getI18nFB_16207ba());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_16207ba() {
/* 2723 */     if (context.get("nc.ui.uif2.I18nFB#16207ba") != null)
/* 2724 */       return (String)context.get("nc.ui.uif2.I18nFB#16207ba");
/* 2725 */     I18nFB bean = new I18nFB();
/* 2726 */     context.put("&nc.ui.uif2.I18nFB#16207ba", bean);bean.setResDir("common");
...
/* 2733 */       context.put("nc.ui.uif2.I18nFB#16207ba", product);
...
/* 2746 */     bean.setName(getI18nFB_e98298());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_e98298() {
/* 2754 */     if (context.get("nc.ui.uif2.I18nFB#e98298") != null)
/* 2755 */       return (String)context.get("nc.ui.uif2.I18nFB#e98298");
/* 2756 */     I18nFB bean = new I18nFB();
/* 2757 */     context.put("&nc.ui.uif2.I18nFB#e98298", bean);bean.setResDir("common");
...
/* 2764 */       context.put("nc.ui.uif2.I18nFB#e98298", product);
...
/* 2777 */     bean.setName(getI18nFB_7cd2db());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_7cd2db() {
/* 2785 */     if (context.get("nc.ui.uif2.I18nFB#7cd2db") != null)
/* 2786 */       return (String)context.get("nc.ui.uif2.I18nFB#7cd2db");
/* 2787 */     I18nFB bean = new I18nFB();
/* 2788 */     context.put("&nc.ui.uif2.I18nFB#7cd2db", bean);bean.setResDir("common");
...
/* 2795 */       context.put("nc.ui.uif2.I18nFB#7cd2db", product);
...
/* 2808 */     bean.setName(getI18nFB_f73886());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_f73886() {
/* 2816 */     if (context.get("nc.ui.uif2.I18nFB#f73886") != null)
/* 2817 */       return (String)context.get("nc.ui.uif2.I18nFB#f73886");
/* 2818 */     I18nFB bean = new I18nFB();
/* 2819 */     context.put("&nc.ui.uif2.I18nFB#f73886", bean);bean.setResDir("common");
...
/* 2826 */       context.put("nc.ui.uif2.I18nFB#f73886", product);
...
/* 2839 */     bean.setName(getI18nFB_a0182c());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_a0182c() {
/* 2847 */     if (context.get("nc.ui.uif2.I18nFB#a0182c") != null)
/* 2848 */       return (String)context.get("nc.ui.uif2.I18nFB#a0182c");
/* 2849 */     I18nFB bean = new I18nFB();
/* 2850 */     context.put("&nc.ui.uif2.I18nFB#a0182c", bean);bean.setResDir("common");
...
/* 2857 */       context.put("nc.ui.uif2.I18nFB#a0182c", product);
...
/* 2870 */     bean.setName(getI18nFB_931c1b());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_931c1b() {
/* 2878 */     if (context.get("nc.ui.uif2.I18nFB#931c1b") != null)
/* 2879 */       return (String)context.get("nc.ui.uif2.I18nFB#931c1b");
/* 2880 */     I18nFB bean = new I18nFB();
/* 2881 */     context.put("&nc.ui.uif2.I18nFB#931c1b", bean);bean.setResDir("common");
...
/* 2888 */       context.put("nc.ui.uif2.I18nFB#931c1b", product);
...
/* 2901 */     bean.setName(getI18nFB_1a5f11());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_1a5f11() {
/* 2909 */     if (context.get("nc.ui.uif2.I18nFB#1a5f11") != null)
/* 2910 */       return (String)context.get("nc.ui.uif2.I18nFB#1a5f11");
/* 2911 */     I18nFB bean = new I18nFB();
/* 2912 */     context.put("&nc.ui.uif2.I18nFB#1a5f11", bean);bean.setResDir("common");
...
/* 2919 */       context.put("nc.ui.uif2.I18nFB#1a5f11", product);
...
/* 2932 */     bean.setName(getI18nFB_1578e96());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_1578e96() {
/* 2940 */     if (context.get("nc.ui.uif2.I18nFB#1578e96") != null)
/* 2941 */       return (String)context.get("nc.ui.uif2.I18nFB#1578e96");
/* 2942 */     I18nFB bean = new I18nFB();
/* 2943 */     context.put("&nc.ui.uif2.I18nFB#1578e96", bean);bean.setResDir("2006pub_0");
...
/* 2950 */       context.put("nc.ui.uif2.I18nFB#1578e96", product);
...
/* 2963 */     bean.setName(getI18nFB_1524499());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_1524499() {
/* 2971 */     if (context.get("nc.ui.uif2.I18nFB#1524499") != null)
/* 2972 */       return (String)context.get("nc.ui.uif2.I18nFB#1524499");
/* 2973 */     I18nFB bean = new I18nFB();
/* 2974 */     context.put("&nc.ui.uif2.I18nFB#1524499", bean);bean.setResDir("common");
...
/* 2981 */       context.put("nc.ui.uif2.I18nFB#1524499", product);
...
/* 2994 */     bean.setName(getI18nFB_15a5cb());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_15a5cb() {
/* 3002 */     if (context.get("nc.ui.uif2.I18nFB#15a5cb") != null)
/* 3003 */       return (String)context.get("nc.ui.uif2.I18nFB#15a5cb");
/* 3004 */     I18nFB bean = new I18nFB();
/* 3005 */     context.put("&nc.ui.uif2.I18nFB#15a5cb", bean);bean.setResDir("common");
...
/* 3012 */       context.put("nc.ui.uif2.I18nFB#15a5cb", product);
...
/* 3025 */     bean.setName(getI18nFB_c1c0b0());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_c1c0b0() {
/* 3033 */     if (context.get("nc.ui.uif2.I18nFB#c1c0b0") != null)
/* 3034 */       return (String)context.get("nc.ui.uif2.I18nFB#c1c0b0");
/* 3035 */     I18nFB bean = new I18nFB();
/* 3036 */     context.put("&nc.ui.uif2.I18nFB#c1c0b0", bean);bean.setResDir("pubapp_0");
...
/* 3136 */     bean.setName(getI18nFB_153faf3());
...
/*      */   }
/*      */   
/*      */   private String getI18nFB_153faf3() {
/* 3144 */     if (context.get("nc.ui.uif2.I18nFB#153faf3") != null)
/* 3145 */       return (String)context.get("nc.ui.uif2.I18nFB#153faf3");
/* 3146 */     I18nFB bean = new I18nFB();
/* 3147 */     context.put("&nc.ui.uif2.I18nFB#153faf3", bean);bean.setResDir("common");
...
/* 3154 */       context.put("nc.ui.uif2.I18nFB#153faf3", product);
...
/* 3164 */     String bean = new String("money_de");context.put("defMoneyField", bean);
...
/* 3173 */     String bean = new String("F0");context.put("defBillType", bean);
...
/* 3182 */     String bean = new String("D0");context.put("defNodeKey", bean);
...
/* 3191 */     String bean = new String("arap.recbill");context.put("mdFullnameHead", bean);
...
/* 3200 */     String bean = new String("arap.recitem");context.put("mdFullnameBody", bean);
...
/* 3208 */       return (nc.ui.arap.actions.RecLineDefValUtil)context.get("iArapLineDefValUtil");
/* 3209 */     nc.ui.arap.actions.RecLineDefValUtil bean = new nc.ui.arap.actions.RecLineDefValUtil();
...
/* 3218 */       return (nc.ui.arap.model.ReceivableBillAppModelService)context.get("ManageModelService");
/* 3219 */     nc.ui.arap.model.ReceivableBillAppModelService bean = new nc.ui.arap.model.ReceivableBillAppModelService();
...
/* 3227 */     if (context.get("paginationQueryService") != null)
/* 3228 */       return (nc.ui.arap.model.ReceivableBillPaginationQueryService)context.get("paginationQueryService");
/* 3229 */     nc.ui.arap.model.ReceivableBillPaginationQueryService bean = new nc.ui.arap.model.ReceivableBillPaginationQueryService();
/* 3230 */     context.put("paginationQueryService", bean);
/* 3231 */     bean.setPageSize(Integer.valueOf(10));
...
/* 3238 */     if (context.get("billDefVauleItf") != null)
/* 3239 */       return (nc.ui.arap.view.ReceivableBillDefValue)context.get("billDefVauleItf");
/* 3240 */     nc.ui.arap.view.ReceivableBillDefValue bean = new nc.ui.arap.view.ReceivableBillDefValue();
/* 3241 */     context.put("billDefVauleItf", bean);
/* 3242 */     bean.setEditor(getBillFormEditor());
...
/* 3249 */     if (context.get("calFldsItf") != null)
/* 3250 */       return (nc.ui.arap.viewhandler.DebitBillCalculatorFields)context.get("calFldsItf");
/* 3251 */     nc.ui.arap.viewhandler.DebitBillCalculatorFields bean = new nc.ui.arap.viewhandler.DebitBillCalculatorFields();
/* 3252 */     context.put("calFldsItf", bean);
/* 3253 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3254 */     invokeInitializingBean(bean);
/* 3255 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.actions.TransTypeAction getTranstype() {
/* 3259 */     if (context.get("transtype") != null)
/* 3260 */       return (nc.ui.arap.actions.TransTypeAction)context.get("transtype");
/* 3261 */     nc.ui.arap.actions.TransTypeAction bean = new nc.ui.arap.actions.TransTypeAction();
/* 3262 */     context.put("transtype", bean);
/* 3263 */     bean.setModel(getManageAppModel());
/* 3264 */     bean.setTransTypeRefModel(getTransTypeRefModel());
/* 3265 */     bean.setWherepart(" parentbilltype ='F0' and pk_group != 'global00000000000000'");
/* 3266 */     bean.setEditor(getBillFormEditor());
/* 3267 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3268 */     invokeInitializingBean(bean);
/* 3269 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.actions.BillSaveAction getSaveActionReal() {
/* 3273 */     if (context.get("saveActionReal") != null)
/* 3274 */       return (nc.ui.arap.actions.BillSaveAction)context.get("saveActionReal");
/* 3275 */     nc.ui.arap.actions.BillSaveAction bean = new nc.ui.arap.actions.BillSaveAction();
/* 3276 */     context.put("saveActionReal", bean);
/* 3277 */     bean.setModel(getManageAppModel());
/* 3278 */     bean.setEditor(getBillFormEditor());
/* 3279 */     bean.setInterceptor(getInterceptor());
/* 3280 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3281 */     invokeInitializingBean(bean);
/* 3282 */     return bean;
/*      */   }
//libin
...
/* 3286 */     if (context.get("ApproveActionReal") != null)
/* 3287 */       return (nc.ui.arap.actions.BillApproveAction)context.get("ApproveActionReal");
/* 3288 */     nc.ui.arap.actions.BillApproveAction bean = new nc.ui.arap.actions.BillApproveAction();
/* 3289 */     context.put("ApproveActionReal", bean);
/* 3290 */     bean.setModel(getManageAppModel());
/* 3291 */     bean.setEditor(getBillFormEditor());
/* 3292 */     bean.setInterceptor(getInterceptor());
/* 3293 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3294 */     invokeInitializingBean(bean);
/* 3295 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.actions.BillListApproveAction getApproveListActionReal() {
/* 3299 */     if (context.get("ApproveListActionReal") != null)
/* 3300 */       return (nc.ui.arap.actions.BillListApproveAction)context.get("ApproveListActionReal");
/* 3301 */     nc.ui.arap.actions.BillListApproveAction bean = new nc.ui.arap.actions.BillListApproveAction();
/* 3302 */     context.put("ApproveListActionReal", bean);
/* 3303 */     bean.setModel(getManageAppModel());
/* 3304 */     bean.setEditor(getListView());
/* 3305 */     bean.setIsbatch("N");
/* 3306 */     bean.setInterceptor(getInterceptor());
/* 3307 */     bean.setTpaProgressUtil(getTPAProgressUtil_8084ec());
/* 3308 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3309 */     invokeInitializingBean(bean);
/* 3310 */     return bean;
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_8084ec() {
/* 3314 */     if (context.get("nc.ui.uif2.components.progress.TPAProgressUtil#8084ec") != null)
/* 3315 */       return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#8084ec");
/* 3316 */     nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
/* 3317 */     context.put("nc.ui.uif2.components.progress.TPAProgressUtil#8084ec", bean);
/* 3318 */     bean.setContext(getContext());
/* 3319 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3320 */     invokeInitializingBean(bean);
/* 3321 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.actions.BillListApproveAction getApproveListBatchActionReal() {
/* 3325 */     if (context.get("ApproveListBatchActionReal") != null)
/* 3326 */       return (nc.ui.arap.actions.BillListApproveAction)context.get("ApproveListBatchActionReal");
/* 3327 */     nc.ui.arap.actions.BillListApproveAction bean = new nc.ui.arap.actions.BillListApproveAction();
/* 3328 */     context.put("ApproveListBatchActionReal", bean);
/* 3329 */     bean.setModel(getManageAppModel());
/* 3330 */     bean.setEditor(getListView());
/* 3331 */     bean.setIsbatch("Y");
/* 3332 */     bean.setInterceptor(getInterceptor());
/* 3333 */     bean.setTpaProgressUtil(getTPAProgressUtil_196beee());
/* 3334 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3335 */     invokeInitializingBean(bean);
/* 3336 */     return bean;
/*      */   }
/*      */   
/*      */   private nc.ui.uif2.components.progress.TPAProgressUtil getTPAProgressUtil_196beee() {
/* 3340 */     if (context.get("nc.ui.uif2.components.progress.TPAProgressUtil#196beee") != null)
/* 3341 */       return (nc.ui.uif2.components.progress.TPAProgressUtil)context.get("nc.ui.uif2.components.progress.TPAProgressUtil#196beee");
/* 3342 */     nc.ui.uif2.components.progress.TPAProgressUtil bean = new nc.ui.uif2.components.progress.TPAProgressUtil();
/* 3343 */     context.put("nc.ui.uif2.components.progress.TPAProgressUtil#196beee", bean);
/* 3344 */     bean.setContext(getContext());
/* 3345 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3346 */     invokeInitializingBean(bean);
/* 3347 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.actions.BillDeleteAction getDeleteActionReal() {
/* 3351 */     if (context.get("deleteActionReal") != null)
/* 3352 */       return (nc.ui.arap.actions.BillDeleteAction)context.get("deleteActionReal");
/* 3353 */     nc.ui.arap.actions.BillDeleteAction bean = new nc.ui.arap.actions.BillDeleteAction();
/* 3354 */     context.put("deleteActionReal", bean);
/* 3355 */     bean.setEditor(getBillFormEditor());
/* 3356 */     bean.setModel(getManageAppModel());
/* 3357 */     bean.setListView(getListView());
/* 3358 */     bean.setInterceptor(getInterceptor());
/* 3359 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3360 */     invokeInitializingBean(bean);
/* 3361 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.pubapp.uif2app.model.AppEventHandlerMediator getAppEventHandlerMediator() {
/* 3365 */     if (context.get("AppEventHandlerMediator") != null)
/* 3366 */       return (nc.ui.pubapp.uif2app.model.AppEventHandlerMediator)context.get("AppEventHandlerMediator");
/* 3367 */     nc.ui.pubapp.uif2app.model.AppEventHandlerMediator bean = new nc.ui.pubapp.uif2app.model.AppEventHandlerMediator();
/* 3368 */     context.put("AppEventHandlerMediator", bean);
/* 3369 */     bean.setModel(getManageAppModel());
/* 3370 */     bean.setHandlerMap(getManagedMap0());
/* 3371 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3372 */     invokeInitializingBean(bean);
/* 3373 */     return bean;
/*      */   }
/*      */   
/* 3376 */   private Map getManagedMap0() { Map map = new java.util.HashMap();map.put("nc.ui.pubapp.uif2app.event.card.CardBodyBeforeEditEvent", getManagedList31());map.put("nc.ui.pubapp.uif2app.event.card.CardBodyAfterEditEvent", getManagedList32());map.put("nc.ui.arap.viewhandler.CardBodyAfterEditEvent", getManagedList33());map.put("nc.ui.arap.viewhandler.cardafter.CardBodyAfterEditCalTaxEvent", getManagedList34());map.put("nc.ui.arap.viewhandler.cardafter.CardBodyAfterEditTaxShowEvent", getManagedList35());map.put("nc.ui.pubapp.uif2app.event.card.CardHeadTailBeforeEditEvent", getManagedList36());map.put("nc.ui.pubapp.uif2app.event.card.CardHeadTailAfterEditEvent", getManagedList37());map.put("nc.ui.pubapp.uif2app.event.card.CardPanelLoadEvent", getManagedList38());map.put("nc.ui.pubapp.uif2app.event.list.ListPanelLoadEvent", getManagedList39());map.put("nc.ui.pubapp.uif2app.event.list.ListHeadRowChangedEvent", getManagedList40());map.put("nc.ui.pubapp.uif2app.event.card.CardBodyRowChangedEvent", getManagedList41());map.put("nc.ui.pubapp.uif2app.event.list.ListHeadDataChangedEvent", getManagedList42());map.put("nc.ui.pubapp.uif2app.event.card.CardBodyAfterRowEditEvent", getManagedList43());map.put("nc.ui.pubapp.uif2app.mediator.mutiltrans.NodekeyEvent", getManagedList44());return map; }
/*      */   
/* 3378 */   private List getManagedList31() { List list = new ArrayList();list.add(getBodyBankAccBeforeEditHandler());list.add(getBodyAccountRefBeforeEditHandler());list.add(getBodyFreeCustBeforeEditHandler());list.add(getBodyProjectBeforeEditHandler());list.add(getOtherOrgBodyBeforeEditHandler());list.add(getPayTermBodyBeforeEditHandler());list.add(getBodyCrossCheckBeforeHandler());list.add(getBodySummaryBeforeEditHandler());list.add(getBodyVersionRefBeforeEditHandler());list.add(getBodySoBilltypeBeforeEditHandler());list.add(getBodyCostCenterRefBeforeEditHandler());list.add(getBodyTaxcodeBeforeEditHandler());list.add(getBodyPsnDocBeforeEditHandler());return list; }
/*      */   
/* 3380 */   private List getManagedList32() { List list = new ArrayList();list.add(getBodyAutoAddLineBeforeEditHandler());list.add(getBodyMaterialAfterEditHandler());list.add(getBodyPsnDocAfterEditHandler());list.add(getBodyCurrTypeAfterEditHandler());list.add(getBodyLocalMoneyAfterEditHandler());list.add(getBodyRateAfterEditHandler());list.add(getCardAfterEditCalculateHandler());list.add(getBodyEuroAfterEditHandler());list.add(getOtherOrgBodyAfterEditHandler());list.add(getBodyMoneyBalanceAfterEditHandler());list.add(getBodyMoneyBalanceAfterEditHandler());list.add(getEnableCtrlBodyAfterEditHandler());list.add(getBodyFundplanAfterEditHandler());list.add(getBodyCuspAfterEditHandler());list.add(getBodyBankAccAfterEditHandler());list.add(getBodyDeptAfterEditHandler());list.add(getBodyVersionRefAfterEditHandler());list.add(getBodyCostCenterAfterEditHandler());list.add(getBodyDefRelationAfterEditHandler());return list; }
/*      */   
/* 3382 */   private List getManagedList33() { List list = new ArrayList();list.add(getBodyEuroAfterEditHandler());list.add(getBodyCuspAfterEditHandler());return list; }
/*      */   
/* 3384 */   private List getManagedList34() { List list = new ArrayList();list.add(getCardAfterEditCalculateHandler());return list; }
/*      */   
/* 3386 */   private List getManagedList35() { List list = new ArrayList();list.add(getTaxForm());return list; }
/*      */   
/* 3388 */   private List getManagedList36() { List list = new ArrayList();list.add(getHeadBankAccBeforeEditHandler());list.add(getOtherOrgHeadBeforeEditHandler());list.add(getHeadCrossCheckBeforeHandler());list.add(getHeadSummaryBeforeEditHandler());list.add(getHeadVersionRefBeforeEditHandler());list.add(getHeadCostCenterRefBeforeEditHandler());list.add(getHeadAccountRefBeforeEditHandler());list.add(getHeadPsnDocBeforeEditHandler());return list; }
/*      */   
/* 3390 */   private List getManagedList37() { List list = new ArrayList();list.add(getHBRelationAfterEditHandler());list.add(getHeadCurrTypeAfterEditHandler());list.add(getOtherOrgHeadAfterEdithandler());list.add(getObjTypeHeadAfterEdithandler());list.add(getHeadPsnDocAfterEditHandler());list.add(getHeadFundplanAfterEditHandler());list.add(getHeadCuspAfterEditHandler());list.add(getHeadDeptAfterEditHandler());list.add(getHeadVersionRefAfterEditHandler());list.add(getHeadEuroAfterEditHandler());list.add(getHeadCostCenterAfterEditHandler());list.add(getHeadBillDateAfterEditHandler());list.add(getDefRelationAfterEditHandler());return list; }
/*      */   
/* 3392 */   private List getManagedList38() { List list = new ArrayList();list.add(getLoadBillCardTemplate());return list; }
/*      */   
/* 3394 */   private List getManagedList39() { List list = new ArrayList();list.add(getLoadBillListTemplate());return list; }
/*      */   
/* 3396 */   private List getManagedList40() { List list = new ArrayList();list.add(getListHeadRowChangeListener());list.add(getSideFormMediator());return list; }
/*      */   
/* 3398 */   private List getManagedList41() { List list = new ArrayList();list.add(getCardBodyRowChangeHandler());list.add(getSideFormMediator());return list; }
/*      */   
/* 3400 */   private List getManagedList42() { List list = new ArrayList();list.add(getListHeadModelListener());return list; }
/*      */   
/* 3402 */   private List getManagedList43() { List list = new ArrayList();list.add(getCardBodyAfterRowEditHandler());return list; }
/*      */   
/* 3404 */   private List getManagedList44() { List list = new ArrayList();list.add(getAddActionGroup());list.add(getTranstype());return list;
/*      */   }
/*      */   
/* 3407 */   public nc.vo.arappub.calculator.data.RelationItemForCal_Debit getRelationItemForCal() { if (context.get("relationItemForCal") != null)
/* 3408 */       return (nc.vo.arappub.calculator.data.RelationItemForCal_Debit)context.get("relationItemForCal");
/* 3409 */     nc.vo.arappub.calculator.data.RelationItemForCal_Debit bean = new nc.vo.arappub.calculator.data.RelationItemForCal_Debit();
/* 3410 */     context.put("relationItemForCal", bean);
/* 3411 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3412 */     invokeInitializingBean(bean);
/* 3413 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.viewhandler.DefRelationAfterEditHandler getDefRelationAfterEditHandler() {
/* 3417 */     if (context.get("DefRelationAfterEditHandler") != null)
/* 3418 */       return (nc.ui.arap.viewhandler.DefRelationAfterEditHandler)context.get("DefRelationAfterEditHandler");
/* 3419 */     nc.ui.arap.viewhandler.DefRelationAfterEditHandler bean = new nc.ui.arap.viewhandler.DefRelationAfterEditHandler();
/* 3420 */     context.put("DefRelationAfterEditHandler", bean);
/* 3421 */     bean.setBillform(getBillFormEditor());
/* 3422 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3423 */     invokeInitializingBean(bean);
/* 3424 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler getBodyDefRelationAfterEditHandler() {
/* 3428 */     if (context.get("BodyDefRelationAfterEditHandler") != null)
/* 3429 */       return (nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler)context.get("BodyDefRelationAfterEditHandler");
/* 3430 */     nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler bean = new nc.ui.arap.viewhandler.cardafter.BodyDefRelationAfterEditHandler();
/* 3431 */     context.put("BodyDefRelationAfterEditHandler", bean);
/* 3432 */     bean.setBillform(getBillFormEditor());
...
/* 3439 */     if (context.get("InitDataListener") != null)
/* 3440 */       return (nc.ui.arap.listener.RecBillRelationQueryDataListener)context.get("InitDataListener");
/* 3441 */     nc.ui.arap.listener.RecBillRelationQueryDataListener bean = new nc.ui.arap.listener.RecBillRelationQueryDataListener();
/* 3442 */     context.put("InitDataListener", bean);
/* 3443 */     bean.setBillFormEditor(getBillFormEditor());
/* 3444 */     bean.setListview(getListView());
/* 3445 */     bean.setContext(getContext());
/* 3446 */     bean.setModel(getManageAppModel());
/* 3447 */     bean.setVoClassName("nc.vo.arap.receivable.AggReceivableBillVO");
/* 3448 */     bean.setAutoShowUpComponent(getBillFormEditor());
/* 3449 */     bean.setQueryAction(getQueryAction());
/* 3450 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3451 */     invokeInitializingBean(bean);
/* 3452 */     return bean;
/*      */   }
/*      */   
/*      */   public MenuAction getBillAssistantActionGroup() {
/* 3456 */     if (context.get("billAssistantActionGroup") != null)
/* 3457 */       return (MenuAction)context.get("billAssistantActionGroup");
/* 3458 */     MenuAction bean = new MenuAction();
/* 3459 */     context.put("billAssistantActionGroup", bean);
/* 3460 */     bean.setCode("billAssistant");
/* 3461 */     bean.setName(getI18nFB_1d13bac());
/* 3462 */     bean.setActions(getManagedList45());
/* 3463 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3464 */     invokeInitializingBean(bean);
/* 3465 */     return bean;
/*      */   }
/*      */   
/*      */   private String getI18nFB_1d13bac() {
/* 3469 */     if (context.get("nc.ui.uif2.I18nFB#1d13bac") != null)
/* 3470 */       return (String)context.get("nc.ui.uif2.I18nFB#1d13bac");
/* 3471 */     I18nFB bean = new I18nFB();
/* 3472 */     context.put("&nc.ui.uif2.I18nFB#1d13bac", bean);bean.setResDir("2006pub_0");
/* 3473 */     bean.setResId("02006pub-0643");
/* 3474 */     bean.setDefaultValue("��������");
/* 3475 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3476 */     invokeInitializingBean(bean);
/*      */     try {
/* 3478 */       Object product = bean.getObject();
/* 3479 */       context.put("nc.ui.uif2.I18nFB#1d13bac", product);
/* 3480 */       return (String)product;
/*      */     } catch (Exception e) {
/* 3482 */       throw new RuntimeException(e); } }
/*      */   
/* 3484 */   private List getManagedList45() { List list = new ArrayList();list.add(getDocumentManage());list.add(getTaxinfoLinkQueryAction());return list;
/*      */   }
/*      */   
/* 3487 */   public nc.ui.arap.actions.LinkQueryTaxInfoAction getTaxinfoLinkQueryAction() { if (context.get("taxinfoLinkQueryAction") != null)
/* 3488 */       return (nc.ui.arap.actions.LinkQueryTaxInfoAction)context.get("taxinfoLinkQueryAction");
/* 3489 */     nc.ui.arap.actions.LinkQueryTaxInfoAction bean = new nc.ui.arap.actions.LinkQueryTaxInfoAction();
/* 3490 */     context.put("taxinfoLinkQueryAction", bean);
/* 3491 */     bean.setModel(getManageAppModel());
/* 3492 */     bean.setEditor(getBillFormEditor());
/* 3493 */     bean.setInterceptor(getInterceptor());
...
/* 3500 */     if (context.get("billAssistantActionGroup_List") != null)
/* 3501 */       return (MenuAction)context.get("billAssistantActionGroup_List");
/* 3502 */     MenuAction bean = new MenuAction();
/* 3503 */     context.put("billAssistantActionGroup_List", bean);
/* 3504 */     bean.setCode("billAssistant");
/* 3505 */     bean.setName(getI18nFB_1a4b3c7());
/* 3506 */     bean.setActions(getManagedList46());
/* 3507 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3508 */     invokeInitializingBean(bean);
/* 3509 */     return bean;
/*      */   }
/*      */   
/*      */   private String getI18nFB_1a4b3c7() {
/* 3513 */     if (context.get("nc.ui.uif2.I18nFB#1a4b3c7") != null)
/* 3514 */       return (String)context.get("nc.ui.uif2.I18nFB#1a4b3c7");
/* 3515 */     I18nFB bean = new I18nFB();
/* 3516 */     context.put("&nc.ui.uif2.I18nFB#1a4b3c7", bean);bean.setResDir("2006pub_0");
/* 3517 */     bean.setResId("02006pub-0643");
/* 3518 */     bean.setDefaultValue("��������");
/* 3519 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3520 */     invokeInitializingBean(bean);
/*      */     try {
/* 3522 */       Object product = bean.getObject();
/* 3523 */       context.put("nc.ui.uif2.I18nFB#1a4b3c7", product);
/* 3524 */       return (String)product;
/*      */     } catch (Exception e) {
/* 3526 */       throw new RuntimeException(e); } }
/*      */   
/* 3528 */   private List getManagedList46() { List list = new ArrayList();return list;
/*      */   }
/*      */   
/* 3531 */   public nc.ui.arap.importable.ReceivableRecordImportablePanel getImportableEditor() { if (context.get("importableEditor") != null)
/* 3532 */       return (nc.ui.arap.importable.ReceivableRecordImportablePanel)context.get("importableEditor");
/* 3533 */     nc.ui.arap.importable.ReceivableRecordImportablePanel bean = new nc.ui.arap.importable.ReceivableRecordImportablePanel();
/* 3534 */     context.put("importableEditor", bean);
/* 3535 */     bean.setUiEditor(getBillFormEditor());
/* 3536 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3537 */     invokeInitializingBean(bean);
/* 3538 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.importable.action.ArapImportAction getImportAction() {
/* 3542 */     if (context.get("importAction") != null)
/* 3543 */       return (nc.ui.arap.importable.action.ArapImportAction)context.get("importAction");
/* 3544 */     nc.ui.arap.importable.action.ArapImportAction bean = new nc.ui.arap.importable.action.ArapImportAction();
/* 3545 */     context.put("importAction", bean);
/* 3546 */     bean.setModel(getManageAppModel());
/* 3547 */     bean.setImportableEditor(getImportableEditor());
/* 3548 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3549 */     invokeInitializingBean(bean);
/* 3550 */     return bean;
/*      */   }
/*      */   
/*      */   public nc.ui.arap.importable.ArapExportAction getExportAction() {
/* 3554 */     if (context.get("exportAction") != null)
/* 3555 */       return (nc.ui.arap.importable.ArapExportAction)context.get("exportAction");
/* 3556 */     nc.ui.arap.importable.ArapExportAction bean = new nc.ui.arap.importable.ArapExportAction();
/* 3557 */     context.put("exportAction", bean);
/* 3558 */     bean.setImportableEditor(getImportableEditor());
/* 3559 */     bean.setModel(getManageAppModel());
/* 3560 */     bean.setInterceptor(getExportActionInterceptor());
...
/* 3567 */     if (context.get("importexportActionGroup") != null)
/* 3568 */       return (MenuAction)context.get("importexportActionGroup");
/* 3569 */     MenuAction bean = new MenuAction();
/* 3570 */     context.put("importexportActionGroup", bean);
/* 3571 */     bean.setCode("ImportExportMenu");
/* 3572 */     bean.setName(getI18nFB_bc9c6d());
/* 3573 */     bean.setActions(getManagedList47());
/* 3574 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3575 */     invokeInitializingBean(bean);
/* 3576 */     return bean;
/*      */   }
/*      */   
/*      */   private String getI18nFB_bc9c6d() {
/* 3580 */     if (context.get("nc.ui.uif2.I18nFB#bc9c6d") != null)
/* 3581 */       return (String)context.get("nc.ui.uif2.I18nFB#bc9c6d");
/* 3582 */     I18nFB bean = new I18nFB();
/* 3583 */     context.put("&nc.ui.uif2.I18nFB#bc9c6d", bean);bean.setResDir("2006pub_0");
/* 3584 */     bean.setResId("02006pub-0654");
/* 3585 */     bean.setDefaultValue("���뵼��");
/* 3586 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3587 */     invokeInitializingBean(bean);
/*      */     try {
/* 3589 */       Object product = bean.getObject();
/* 3590 */       context.put("nc.ui.uif2.I18nFB#bc9c6d", product);
/* 3591 */       return (String)product;
/*      */     } catch (Exception e) {
/* 3593 */       throw new RuntimeException(e); } }
/*      */   
/* 3595 */   private List getManagedList47() { List list = new ArrayList();list.add(getImportAction());list.add(getCurrNullAction());list.add(getExportAction());return list;
/*      */   }
/*      */   
/* 3598 */   public nc.ui.uif2.actions.StandAloneToftPanelActionContainer getListActions() { if (context.get("listActions") != null)
/* 3599 */       return (nc.ui.uif2.actions.StandAloneToftPanelActionContainer)context.get("listActions");
/* 3600 */     nc.ui.uif2.actions.StandAloneToftPanelActionContainer bean = new nc.ui.uif2.actions.StandAloneToftPanelActionContainer(getListView());context.put("listActions", bean);
/* 3601 */     bean.setActions(getManagedList48());
/* 3602 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3603 */     invokeInitializingBean(bean);
/* 3604 */     return bean;
/*      */   }
/*      */   
/* 3607 */   private List getManagedList48() { List list = new ArrayList();list.add(getAddActionGroup());list.add(getEditAction());list.add(getDeleteAction());list.add(getCopyAction());list.add(getCurrNullAction());list.add(getQueryAction());list.add(getRefreshAllAction());list.add(getCurrNullAction());list.add(getTranstype());list.add(getBillAssistantActionGroup());list.add(getCurrNullAction());list.add(getReceiptMenuAction());list.add(getCurrNullAction());list.add(getRelatedQueryActionGroup());list.add(getCurrNullAction());list.add(getImportexportActionGroup());list.add(getPrintOperateActionGroup_List());return list;
/*      */   }
/*      */   
/* 3610 */   public nc.ui.uif2.actions.StandAloneToftPanelActionContainer getCardActions() { if (context.get("cardActions") != null)
/* 3611 */       return (nc.ui.uif2.actions.StandAloneToftPanelActionContainer)context.get("cardActions");
/* 3612 */     nc.ui.uif2.actions.StandAloneToftPanelActionContainer bean = new nc.ui.uif2.actions.StandAloneToftPanelActionContainer(getBillFormEditor());context.put("cardActions", bean);
/* 3613 */     bean.setActions(getManagedList49());
/* 3614 */     bean.setEditActions(getManagedList50());
/* 3615 */     bean.setModel(getManageAppModel());
/* 3616 */     setBeanFacotryIfBeanFacatoryAware(bean);
/* 3617 */     invokeInitializingBean(bean);
/* 3618 */     return bean;
/*      */   }
/*      */   // libin ����ԭ���水ť��Ϊ �ύ��ť  list.add(getCommitAction());list.add(getRecallAction())
/* 3621 */   private List getManagedList49() { List list = new ArrayList();list.add(getAddActionGroup());list.add(getEditAction());list.add(getDeleteAction());list.add(getCommitAction());list.add(getRecallAction());list.add(getCopyAction());list.add(getCurrNullAction());list.add(getQueryAction());list.add(getRefreshSingAction());list.add(getCurrNullAction());list.add(getTranstype());list.add(getBillAssistantActionGroup());list.add(getCurrNullAction());list.add(getReceiptMenuAction());list.add(getCurrNullAction());list.add(getRelatedQueryActionGroup());list.add(getCurrNullAction());list.add(getImportexportActionGroup());list.add(getPrintOperateActionGroup());return list; }
/*      */   
/* 3623 */   private List getManagedList50() { List list = new ArrayList();list.add(getSaveAction());list.add(getTempSaveAction());list.add(getCurrNullAction());list.add(getCancelAction());list.add(getCurrNullAction());list.add(getDocumentManage());list.add(getReceiptMenuAction());return list;
/*      */   }
/*      */ }

/* Location:           E:\work\Yonyou\home\sdgshome20201022\modules\arap\client\classes
 * Qualified Name:     nc.ui.arap.config.receivablebill_record

	...
	public void doAction(ActionEvent arg0) throws Exception {
		...
		if (this.model.getSelectedData() == null) {
			...
			NCObject ncObj = NCObject
					.newInstance(this.getModel().getSelectedData());
			...
			// if(itf.getApproveStatus() == 1){
				if("264X-Cxx-CNFTFSPD".equals(transi_type)){
					...
					if (billmaker.equals(userid)) {
						if ("0001A110000000000HYQ".equals(userVO.getPk_org()) || "0001A21000000001H7J3".equals(userVO.getPk_org()) || "0001A110000000087PJ0".equals(userVO.getPk_org())) {
							openYXBS(pk_primarykey, userid, user_code);
						}
					} else {

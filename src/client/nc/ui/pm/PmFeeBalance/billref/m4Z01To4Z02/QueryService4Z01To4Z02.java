...
import nc.vo.pubapp.pattern.exception.ExceptionUtils;
 ...
 public class QueryService4Z01To4Z02 implements nc.ui.pubapp.uif2app.query2.model.IRefQueryService
 {
   public QueryService4Z01To4Z02() {}

   public Object[] queryByQueryScheme(IQueryScheme queryScheme) throws Exception
   {     IQuery4Z02For4Z01 service = (IQuery4Z02For4Z01)NCLocator.getInstance().lookup(IQuery4Z02For4Z01.class);

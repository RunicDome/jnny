package nc.ui.pm.pmrlcontractschedule.ace.action;
...
public class AddFromSource4Z03Action extends AbstractReferenceAction {

	private ShowUpableBillForm editor;
	private AbstractAppModel model;

	public AddFromSource4Z03Action() {
	...
	public void doAction(ActionEvent e) throws Exception {
		...
		if (PfUtilClient.isCloseOK()) {
			AggRLContractschedule[] vos = (AggRLContractschedule[]) PfUtilClient
					.getRetVos();

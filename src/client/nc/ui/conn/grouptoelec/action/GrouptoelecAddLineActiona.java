package nc.ui.conn.grouptoelec.action;
...
*/
public class GrouptoelecAddLineActiona extends BatchAddLineAction {
...
//		singleDocVO.(this.getModel().getContext().getPk_group());
